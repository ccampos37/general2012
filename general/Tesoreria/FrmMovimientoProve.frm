    ...
    If Not contribuyente = True Then
       If monto <= VGParametros.minimoretencion Then
        ...
        ElseIf numdoc > numretencion Then
                  xmsg = "Falta añadir " & numdoc - numretencion & " Comprobantes de Retencion, desea agregar retenciones  "
                  ...
                  Exit Function
            ElseIf numdoc < numretencion Then
                  MsgBox "Falta añadir " & numretencion - numdoc & " Documentos a Pagar ", vbInformation, Caption
                  Exit Function
       End If
...
If Index = 8 Then
   ...
   If rsdetat.RecordCount > 0 Then
      If Index = 6 And Text2(5).Text <> Empty And Len(Trim(Ctr_AyudaCaja.xclave)) = 0 Then
         ...
         Loop
         If lEncontro = True Then
            MsgBox "El Nº de Cheque debe ser el mismo para los Documentos", vbInformation, Caption
            Text2(6).Text = Empty
            Text2(6).SetFocus
         End If
      End If
   ...
   If Index = 6 And Text2(5).Text <> Empty And Len(Trim(Ctr_AyudaCaja.xclave)) = 0 Then
    If Trim(Text2(9).Text) = Empty Then
        MsgBox "Debe ingresar Nº de cuenta corriente", vbInformation, Caption
        Text2(6).Text = Empty
        Text2(9).SetFocus
    Else
      ...
      Set rs = VGCNx.Execute(SQL)
      If rs(0) > 0 Then
         If MsgBox("El Nº de Cheque ya fue registrado , desea continuar (S/N)") = vbNo Then
            Text2(6).Text = Empty
            Text2(6).SetFocus
         End If
      End If
 ...
 Dim VSnro As String
  If KeyAscii = 13 Then
    ...
    ElseIf Index = 2 Then
        ...
        If adll.ComboDato(Combo1.Text) = "I" Then
          If rb.RecordCount > 0 Then
             MsgBox "Existe el Nº Documento Referenciado...Verifique!!", vbInformation, MsgTitle
             Text2(2).SetFocus
             Exit Sub
          End If
       Else
