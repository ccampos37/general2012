...
Private Sub DGrid1_HeadClick(ByVal ColIndex As Integer)
  Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, ColIndex + 1, nlongi, xCondi)
  ConfigGrid xtipo
End Sub
 ...
 If KeyCode = 13 Then
    If DGrid1.Row >= 0 Then
        Select Case xtipo
          ...
          Case 5
             nDetalle = Trim(DGrid1.Columns(1).Text)
             nMoneda = DGrid1.Columns(2).Text
             nAyuda = DGrid1.Columns(4).Text
             nAyuda1 = DGrid1.Columns(7).Text
          End Select
    End If
    xdata = ""
    Unload Me
...
Private Sub Form_Load()
  ...
  If Trim(Escadena(xdata)) = "1" Then
     Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, xOrden, nlongi, "productodescripcion like '" & xdato & "%'")
     Text1 = Escadena(xdato): Text1.SelStart = Len(Trim(Text1))
  ElseIf Trim(Escadena(xdata)) = "2" Then
     Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, xOrden, nlongi, "clienterazonsocial like '" & xdato & "%'")
     Text1 = Escadena(xdato): Text1.SelStart = Len(Trim(Text1))
  Else
     Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, xOrden, nlongi, xCondi)
  End If
  ConfigGrid xtipo
End Sub
...
Public Function ConfigGrid(xtipo As Integer)
   ...
   Select Case xtipo
     Case 1
        DGrid1.Columns(0).Width = 1500
        DGrid1.Columns(1).Width = 4000
     ...
     Case 5
        ...
        DGrid1.Columns(1).Width = 1400
        DGrid1.Columns(2).Width = 600
        DGrid1.Columns(3).Width = 1200
        DGrid1.Columns(4).Width = 1200
        DGrid1.Columns(5).Width = 1200
        DGrid1.Columns(6).Width = 1650
        DGrid1.Columns(7).Width = 0
        DGrid1.Columns(3).NumberFormat = "##,###,##0.00"
...
Private Sub Text1_Change()
    ...
    If Len(Trim(xCondi)) = 0 Then
       Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, xOrden, nlongi, nfiltra(posi, 2) & " Like '" & Text1 & "%'")
    Else
       Call adll.ListarEnTDBGRID(vcon, xtabla, DGrid1, xCampos, xOrden, nlongi, xCondi & " and " & nfiltra(posi, 2) & " Like '" & Text1 & "%'")
    End If
    ConfigGrid xtipo
End Sub
