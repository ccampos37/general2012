...
Begin VB.Form frmMantRecibos 
   ...
   Begin TabDlg.SSTab SSTabMant 
      ...
      TabPicture(0)   =   "frmMantRecibos.frx":1272
      ...
      TabPicture(1)   =   "frmMantRecibos.frx":128E
      ...
      Begin VB.Frame FrameCabecera 
         ...
         Begin VB.ComboBox CmbTcambio 
            Enabled         =   0   'False
            Height          =   288
            ItemData        =   "frmMantRecibos.frx":12AA
            Left            =   8136
            List            =   "frmMantRecibos.frx":12B7
      ...
      Begin VB.Frame FrameConsul 
         ...
         Begin VB.Image Image1 
            Height          =   372
            Left            =   132
            Picture         =   "frmMantRecibos.frx":12E3
            Stretch         =   -1  'True
            Top             =   216
            Width           =   456
         End
      ...
      Begin MSComctlLib.StatusBar StBar 
         ...
         BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Panel3 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
               ...
               AutoSize        =   1
               Object.Width           =   8334
               Picture         =   "frmMantRecibos.frx":2555
               Text            =   "Estado :"
               TextSave        =   "Estado :"
            EndProperty
         EndProperty
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabsPerRow      =   1
         TabHeight       =   520
         MouseIcon       =   "frmMantRecibos.frx":37D7
         TabCaption(0)   =   "&Ingreso del detalle"
         TabPicture(0)   =   "frmMantRecibos.frx":37F3
         Tab(0).ControlEnabled=   -1  'True
   ...
   End
End
Attribute VB_Name = "frmMantRecibos"
...
Private Sub Mostrar()
    ...
    Set ClsMM1 = New ClsMantMovimientos
    Set VGvardllgen = New dllgeneral.dll_general
    Call ClsMM1.MostrarCabecera(rscabecera.Fields, 0)
    Call ClsMM1.Limpia(0)
    Call PrepararTemporalDetalle
...
varnerror = 0
    ...
    If frmMantRecibos.IMant = 1 Then
       xnumero = ActualizaNumeroAuto("te_parametroempresa", 1, VGCNx, 1)
     Else
       xnumero = CDbl(frmMantRecibos.lbNumComprobCab)
    End If
    ...
    If ChkCtaCte.Value = 1 Then
        Call ClsMM1.GrabarCP_abono(IMant, xnumero, rsmantenimiento)
    End If
