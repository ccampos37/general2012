...
Begin VB.Form FrmCierreMensual 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         Columns(3).Caption=   "Moneda/Cta. Banco"
         Columns(3).DataField=   "moneda"
         Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(4)._VlistStyle=   0
         Columns(4)._MaxComboItems=   5
         Columns(4).Caption=   "S. inicial"
         Columns(4).DataField=   "saldoinicial"
         Columns(4).EditMask=   "####,###.##"
         Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(5)._VlistStyle=   0
         Columns(5)._MaxComboItems=   5
         Columns(5).Caption=   "Ingresos Mes"
         Columns(5).DataField=   "totalingresos"
         Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(6)._VlistStyle=   0
         Columns(6)._MaxComboItems=   5
         Columns(6).Caption=   "Egresos Mes"
         Columns(6).DataField=   "totalegresos"
         Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(7)._VlistStyle=   0
         Columns(7)._MaxComboItems=   5
         Columns(7).Caption=   "Saldo Final"
         Columns(7).DataField=   "saldofinal"
         ...
         Splits(0)._ColumnProps(11)=   "Column(2)._WidthInPix=2672"
         ...
         Splits(0)._ColumnProps(21)=   "Column(5).Width=1826"
         Splits(0)._ColumnProps(22)=   "Column(5).DividerColor=0"
         Splits(0)._ColumnProps(23)=   "Column(5)._WidthInPix=1746"
    ...
    If Opt(0).Value Then
       .Parameters("@tipo") = "C"
        If Check1.Value = 0 Then
           .Parameters("@cajabanco") = Ctr_AyuCaja.xclave
           .Parameters("@ctamoneda") = Ctr_AyuMoneda.xclave
        End If
     Else
       .Parameters("@tipo") = "B"
        If Check1.Value = 0 Then
        ...
        End If
   End If
   .Parameters("@mesactual") = VGParamSistem.AnoProceso + Format(VGParamSistem.MesProceso, "00")
   .Parameters("@mesnuevo") = yyyy + mm
