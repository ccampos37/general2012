...
Begin VB.Form FrmCuentaBancaria 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmCuentaBancaria.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "TDBGrid1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Mantenimiento"
      TabPicture(1)   =   "FrmCuentaBancaria.frx":001C
      ...
      Tab(1).Control(8)=   "Ctr_AyudaEmp"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "Txt(4)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "Txt(3)"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "Txt(2)"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "Txt(1)"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "cCancela"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "cAcepta"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "Ctr_Banco"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "Txt(0)"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "Ctr_Mon"
...
Private Sub Form_Load()
  Call Ctr_Banco.Conexion(VGCNx)
  Call Ctr_Mon.Conexion(VGCNx)
...
Private Function MuestraDatos()
 Dim SQL As String
  SQL = "select empresacodigo as Empresa,cbanco_codigo as Cod_Banco,monedacodigo as Moneda,cbanco_numero as Cuenta,cbanco_referenciacta as Referencia,cbanco_nrocheque,cbanco_cuenta,cbanco_analitico from te_cuentabancos"
...
Sub EditarValores()
 Dim I As Integer
  With TDBGrid1
    Ctr_AyudaEmp.xclave = Trim(.Columns(0).Text): Ctr_AyudaEmp.Ejecutar
    Ctr_Banco.xclave = Trim(.Columns(1).Text): Ctr_Banco.Ejecutar
    Ctr_Mon.xclave = Trim(.Columns(2).Text): Ctr_Mon.Ejecutar
    For I = 0 To 4
      txt(I).Text = Escadena((.Columns(3 + I).Text))
    Next
  End With
End Sub
...
Function ValidaData() As Boolean
 ...
 Dim I As Integer
    ...
    If Ctr_AyudaEmp.xclave = "0" Or Ctr_AyudaEmp.xclave = "00" Then
        MsgBox "Debe ingresar empresa", vbInformation, Caption
        ValidaData = False
        Ctr_AyudaEmp.SetFocus
        Exit Function
    End If
  ValidaData = True
End Function
...
Sub GrabaData()
  ...
  If modoinsert = True Then
     SQL = "INSERT  te_cuentabancos (empresacodigo,cbanco_codigo,monedacodigo,cbanco_numero,cbanco_referenciacta,cbanco_nrocheque,cbanco_cuenta,cbanco_analitico,usuariocodigo,fechaact) "
     SQL = SQL & "VALUES ('" & Trim(Ctr_AyudaEmp.xclave) & "','" & Trim(Ctr_Banco.xclave) & "','" & Trim(Ctr_Mon.xclave) & "','" & Trim(txt(0).Text) & "','" & txt(1).Text & "','" & txt(2).Text & "','" & txt(3).Text & "','" & txt(4).Text & "','" & VGParamSistem.Usuario & "'," & Format(Now, "dd/mm/yyyy") & ")"
     VGCNx.BeginTrans
     VGCNx.Execute (SQL)
     VGCNx.CommitTrans
  ElseIf modoedit = True Then
     ...
     SQL = SQL & "empresacodigo='" & Ctr_AyudaEmp.xclave & "'"
     SQL = SQL & "WHERE cbanco_codigo='" & Trim(Ctr_Banco.xclave) & "' and empresacodigo='" & Ctr_AyudaEmp.xclave & "'"
     SQL = SQL & "And monedacodigo='" & Trim(Ctr_Mon.xclave) & "' AND cbanco_numero='" & Trim(txt(0).Text) & "'"
     VGCNx.BeginTrans
     VGCNx.Execute (SQL)
     VGCNx.CommitTrans
  End If
