...
Begin VB.Form FrmMantenUbica 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   675
         Left            =   4785
         Picture         =   "FrmMantenUbica.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   675
         Left            =   3750
         Picture         =   "FrmMantenUbica.frx":0D0C
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton CmdEli 
         ...
         Height          =   675
         Left            =   2715
         Picture         =   "FrmMantenUbica.frx":114E
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton CmdModi 
         ...
         Height          =   675
         Left            =   1695
         Picture         =   "FrmMantenUbica.frx":1590
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton CmdIng 
         ...
         Height          =   675
         Left            =   660
         Picture         =   "FrmMantenUbica.frx":19D2
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   240
         Width           =   775
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "FrmMantenUbica.frx":1E14
         Height          =   1485
         Left            =   210
         TabIndex        =   12
         Top             =   300
   ...
   End
End
Attribute VB_Name = "FrmMantenUbica"
...
If adodc1.RecordCount > 0 Then
    cSql1 = "Delete from TabUbica Where COD_Alma='" & VGAlma & "' and Cod_Ubic= '" & adodc1("COD_ubic") & "' "
...
If nOperador = 1 Then                  ' Si es Ingreso
    CSQL2 = "Insert Into TabUbica (COD_ALMA,COD_UBIC,DESCRI)"
    CSQL2 = CSQL2 & " Values ('" & VGAlma & "','" & Text1(0) & "','" & SupCadSQL(Text1(1)) & "')"
    
ElseIf nOperador = 2 Then               'Si es Modificación
    CSQL2 = "Update TABUBICA Set DESCRI = '" & SupCadSQL(Text1(1)) & "' "
    CSQL2 = CSQL2 & "  Where COD_UBIC = '" & Text1(0) & "' AND COD_ALMA='" & VGAlma & "' "
End If
...
OculObj (True)
Frame2.Caption = "Ingreso de Ubicación "
Limpiar
nOperador = 1
...
If adodc1.RecordCount > 0 Then
    Limpiar
    nOperador = 2
    Frame2.Caption = "Modificación de Ubicación"
    
    cSql1 = "Select * from TABUBICA where COD_ALMA='" & VGAlma & "' AND  COD_UBIC= '" & adodc1.Fields("COD_UBIC") & "'"
    ...
    If cSel1.RecordCount > 0 Then
        OculObj (True)
        If Not IsNull(cSel1("COD_UBIC")) Then Text1(0) = cSel1("COD_UBIC")
        If Not IsNull(cSel1("DESCRI")) Then Text1(1) = cSel1("DESCRI")
...
adodc1.Open "SELECT * FROM TABUBICA ORDER BY COD_UBIC", VGcnx, adOpenStatic
...
Me.Caption = "TABLA DE UBICACIONES"
cTitulo = "TABLA DE UBICACIONES"
If DataGrid1.Visible Then DataGrid1.SetFocus
End Sub
...
If KeyAscii = 13 Then
    If Trim(Text1(Index)) <> "" Then
      If Index = 0 Then
            If ExisteCod(Text1(0)) Then
                 MsgBox "El Codigo de la Ubicación ya existe", vbInformation, "Inventarios"
                Text1(0).SetFocus: Exit Sub
            End If
          Text1(1).SetFocus: Exit Sub
      ElseIf Index = 1 Then
...
Function ExisteCod(ByVal codUbic As String) As Boolean
Dim rs As New ADODB.Recordset
rs.Open "Select * from tabubica where cod_alma='" & VGAlma & "' and cod_ubic='" & codUbic & "'", VGcnx, adOpenForwardOnly, adLockReadOnly
ExisteCod = IIf(Not rs.EOF, True, False)
rs.Close
End Function
Sub VerificaCargaDatos()
Dim rs As New ADODB.Recordset
Dim Rs2 As New ADODB.Recordset
rs.Open "Select * from tabubica where  cod_alma='" & VGAlma & "'", VGcnx, adOpenStatic, adLockReadOnly
If rs.EOF Then
   Rs2.Open "Select distinct tcasillero from tabcasillero where tcodalm='" & VGAlma & "'", VGcnx, adOpenStatic, adLockReadOnly
   Do While Not Rs2.EOF
      VGcnx.Execute "Insert into tabubica(cod_alma,cod_ubic,descri)values ('" & VGAlma & "','" & Rs2!tcasillero & "','" & Rs2!tcasillero & "') "
      Rs2.MoveNext
   Loop
   Rs2.Close
End If
