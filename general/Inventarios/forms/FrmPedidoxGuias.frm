...
Private Sub cmdGrabaFinal_Click()
    ...
    If MsgBox("Desea Grabar Las Guias?", vbYesNo, MsgTitle) = vbYes Then
       ...
       nsql = "select * from vt_puntovtadocumento where puntovtacodigo='" & g_ptoventa & "' and documentocodigo='LC'"
       Set nrs = cn.Execute(nsql)
        ...
        cn.Execute nsql
        Set nrs = cn.Execute("select * from vt_parametroventa where empresacodigo='" & Right(VGCOMP, 2) & "' ")
...
Private Sub Combo2_LostFocus()
 Dim rst As New ADODB.Recordset
   Set rst = cn.Execute("select * from vt_puntovtadocumento where puntovtacodigo='" & Left(Combo2.text, 2) & "' and documentocodigo='04'")
...
Private Sub Form_Load()
  ...
  nLongicampo(1) = 0
  Call adll.llenacombo(Combo2, "select puntovtacodigo,puntovtadescripcion from vt_puntoventa", cn)
  inicializaarchivo
  Call dllgeneral.ActivaTab(0, 1, SSTab1)
  listado
  ConfiguraGrid
...
Public Function listado()
  ...
  TDBGrid1.ClearFields
  TDBGrid1.Refresh
  Call adll.ListarEnTDBGRID(cn, "movalmcab", TDBGrid1, "carftdoc,carfndoc,caalma,CATD,CANUMDOC, CAFECDOC,CACODCLI,CARUC, CANOMCLI", "carfndoc", nLongicampo, " catd='NI' and catipmov='I' and carftdoc in('04','GR')")
  Call adll.ListarEnTDBGRID(cn, vt_tempo, TDBGrid2, "vt_tipdoc ,vt_numdoc, clientecodigo ,clienterazonsocial ,documentoreferencia, numeroreferencia , almacencodigo", "almacencodigo", nLongicampo, "")
  Call adll.ListarEnTDBGRID(cn, vt_tempo1, TDBGrid4, "productocodigo, productodescripcion, productocantidad, almacencodigo", "productocodigo", nLongicampo, "")
  TDBGrid2.Refresh
  TDBGrid4.Refresh
