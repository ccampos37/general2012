...
Begin VB.Form FrmKardexValEmpresa 
   Caption         =   "Form1"
   ClientHeight    =   4275
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmkardexValEmpresa.frx":0000
         Left            =   2070
         List            =   "FrmkardexValEmpresa.frx":0002
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FrmkardexValEmpresa.frx":0004
         Left            =   1710
         List            =   "FrmkardexValEmpresa.frx":000E
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   1680
         Width           =   3150
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FrmkardexValEmpresa.frx":0022
         Left            =   2040
         List            =   "FrmkardexValEmpresa.frx":0024
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdAceptar 
         ...
         Height          =   690
         Left            =   3360
         Picture         =   "FrmkardexValEmpresa.frx":0026
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   2400
         Width           =   705
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   708
         Left            =   4200
         Picture         =   "FrmkardexValEmpresa.frx":0468
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   2400
         Width           =   705
   ...
   End
End
Attribute VB_Name = "FrmKardexValEmpresa"
