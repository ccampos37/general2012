...
Begin VB.Form FrmKarValC 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FrmKarValC.frx":08CA
         Left            =   1590
         List            =   "FrmKarValC.frx":08D4
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmKarValC.frx":08E8
         Left            =   1560
         List            =   "FrmKarValC.frx":08EA
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   420
         Width           =   2760
...
Dim arrform(7) As Variant, arrparam(2) As Variant
...
If Text1 <> "" And Text2 <> "" Then
 ...
 Else
  ...
  Adodc3.Close
  '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  titrep = "al_kardexCentroCostoDetallado -- Control de Inventarios"
  Reporte = "al_kardexCentroCostoDetallado.rpt"
  Carga_RepoVal
  
  
  arrform(0) = "ALMACEN = '" & UCase(Combo1.text) & "'"
  arrform(1) = "Mes= '" & UCase(Format(DTPicker1, "MMMM - yyyy")) & "'"
  arrform(2) = "hora ='" & Format(Time, "hh:mm:ss") & "'"
  arrform(3) = "ART1= '" & Text1 & "'"
  arrform(4) = "ART2 ='" & Text2 & "'"
  arrform(5) = "des1= '" & Va1 & "'"
  arrform(6) = "des2 ='" & Va2 & "'"
  
  arrparam(0) = VGCNx.DefaultDatabase
  arrparam(1) = VGcnxCT.DefaultDatabase
...
Do While Not adodc1.EOF
       ...
       Else
            If Trim(cCod) = Trim(adodc1("DECODIGO")) Then
                    ...
                    CSQL2 = CSQL2 & "'" & adodc1("CATD") & "','" & adodc1("CANUMDOC") & "', " & adodc1("DECANTID") & ",'" & adodc1("DECENCOS") & "',"
                    If adodc1("CATD") = "NI" Then
...
Adodc3.Open "SELECT centrocostocodigo,centrocostodescripcion FROM ct_centrocosto where  centrocostonivel ='3'", VGCNx, adOpenStatic, adLockOptimistic

frmReferencia.Conectar Adodc3, "SELECT centrocostocodigo,centrocostodescripcion FROM ct_centrocosto where  centrocostonivel ='3'"
