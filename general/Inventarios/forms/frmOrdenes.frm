...
Sub Abre_Tabla_OCs()
    ...
    SQL = "SELECT a.* FROM co_cabordcompra a inner join co_estadoorden b on "
    ...
    SQL = SQL & " and a.estadooccodigo < 2 ORDER BY a.tipoordencodigo,oc_cnumord "
...
Private Sub CmdEli_Click()
    ...
    If MsgBox(Mensaje, vbQuestion + vbYesNo + vbDefaultButton2, "Mensaje") = vbYes Then
        voc = adodc1("tipoordencodigo") & adodc1("oc_cnumord")
        
        nTra = 1
        VGCNx.BeginTrans
        
        strsql = "UPDATE co_detordcompra SET oc_situacionorden=2  WHERE  tipoordencodigo+ oc_cnumord='" & voc & "'"
...
EliErr:
    MsgBox Err.Description
    If nTra = 1 Then VGCNx.RollbackTran
    Exit Sub
    Resume
End Sub
...
End If
    ...
    If adodc1("oc_ccodmon") = "01" Then
     ...
     ElseIf adodc1("oc_ccodmon") = "03" Then
         letras = letras + " Euros "
       Else
...
Private Sub Form_Load()
    ...
    Call Ctrayu_tipoorden.conexion(VGCNx): Ctrayu_tipoorden.filtro = "(isnull(flagrequerimientosOrdenes,0) <> 1 )"
...
Sub Mostrar(cC1 As String)
 ...
 '   lblRuc = Devolver_Dato(1, txtpro, "cp_proveedor", "clientecodigo", False, "clienteruc")
    ...
    cSqlM = "SELECT * FROM co_detordcompra WHERE tipoordencodigo+oc_cnumord='" & adodc1("tipoordencodigo") & cC1 & "' ORDER BY oc_citem"
