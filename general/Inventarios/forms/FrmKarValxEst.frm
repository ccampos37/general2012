...
Begin VB.Form FrmKarValxEst 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmKarValxEst.frx":0000
         Left            =   2070
         List            =   "FrmKarValxEst.frx":0002
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FrmKarValxEst.frx":0004
         Left            =   1710
         List            =   "FrmKarValxEst.frx":000E
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   1680
         Width           =   3150
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FrmKarValxEst.frx":0022
         Left            =   2040
         List            =   "FrmKarValxEst.frx":0024
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   360
         Width           =   2760
      ...
      Begin VB.CommandButton CmdAceptar 
         ...
         Height          =   690
         Left            =   3360
         Picture         =   "FrmKarValxEst.frx":0026
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   2400
         Width           =   705
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   708
         Left            =   4200
         Picture         =   "FrmKarValxEst.frx":0468
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   2400
         Width           =   705
   ...
   End
End
Attribute VB_Name = "FrmKarValxEst"
