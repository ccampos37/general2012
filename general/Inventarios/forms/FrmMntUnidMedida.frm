...
Begin VB.Form FrmMntUnidMedida 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmMntUnidMedida.frx":0000
         Left            =   5040
         List            =   "FrmMntUnidMedida.frx":000A
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton command5 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "FrmMntUnidMedida.frx":0027
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   675
         Left            =   5760
         Picture         =   "FrmMntUnidMedida.frx":0469
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   255
         Width           =   775
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   2520
         Picture         =   "FrmMntUnidMedida.frx":08AB
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmMntUnidMedida.frx":0CED
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmMntUnidMedida.frx":112F
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command19 
         ...
         Height          =   675
         Left            =   4680
         Picture         =   "FrmMntUnidMedida.frx":1571
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   240
         Width           =   775
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command9 
         ...
         Height          =   675
         Left            =   3960
         Picture         =   "FrmMntUnidMedida.frx":3D13
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "FrmMntUnidMedida.frx":4155
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmMntUnidMedida"
