...
Begin VB.Form frmRequerimientosDetalle 
   ...
   End
End
Attribute VB_Name = "frmRequerimientosDetalle"
...
Call CtrAyu_Ccosto.Conexion(VGcnxCT): CtrAyu_Ccosto.filtro = "centrocostonivel='3'"
Call CtrAyu_Analitico.Conexion(VGcnxCT)
Call Ctr_AyuFamilia.Conexion(VGCNx)
txtCan.Enabled = True

cmdOK.Picture = MDIPrincipal.ImageList2.ListImages.item("Nuevo").Picture
cmdCancel.Picture = MDIPrincipal.ImageList2.ListImages.item("Retornar").Picture
