...
Public Function Listado()
  ...
  TDBGrid1.ClearFields
  TDBGrid1.Refresh
  Call adll.ListarEnTDBGRID(VGcnx, "al_liquidacioncompra", TDBGrid1, "pedidotipofac,pedidonrofac,almacencodigo,pedidonumero, pedidofechafact,clientecodigo,clienterazonsocial", "pedidonrofac", nLongicampo, " modovtacodigo='LC' ")
  Call adll.ListarEnTDBGRID(VGcnx, vt_tempo, TDBGrid2, "vt_tipdoc ,vt_numdoc, clientecodigo ,clienterazonsocial ,documentoreferencia, numeroreferencia , almacencodigo", "almacencodigo", nLongicampo, "")
...
'    nvalor = ""
    ...
    Do Until csqld.EOF
       ...
       rsdeta.Fields(5) = numero(csqld!DECODMON)
