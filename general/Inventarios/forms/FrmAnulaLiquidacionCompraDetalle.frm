...
Begin VB.Form FrmAnulaLiquidacionCompraDetalle 
   Caption         =   "Form1"
   ClientHeight    =   7215
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   12
         Left            =   1140
         Picture         =   "FrmAnulaLiquidacionCompraDetalle.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   180
         Width           =   825
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   11
         Left            =   90
         Picture         =   "FrmAnulaLiquidacionCompraDetalle.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   180
         Width           =   870
   ...
   End
End
Attribute VB_Name = "FrmAnulaLiquidacionCompraDetalle"
...
Private Sub cAceptaA_Click()
  ...
  Dim ACMD As New ADODB.Command
    ...
    End If
    If adll.VerificaDatoExistente(VGCNx, "select * from vt_abono where documentoabono='" & nTipo & "' and abononumdoc='" & nnume & "'") = 1 Then
    ...
    If Len(Trim(nnume)) > 0 Then
       ...
       ACMD.CommandText = "al_anulaliquidacioncompra_pro"
