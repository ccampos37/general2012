...
Begin VB.Form FrmStockAlmacen 
   ...
   End
End
Attribute VB_Name = "FrmStockAlmacen"
...
aform(0) = "almacen='" & Combo1.text & "'"
    ...
    If Check1.Value = 0 Then
            ...
            ElseIf Chkprecio = 0 Then
                    Call ImpresionRptProc("al_SaldosxAlmacen.rpt", aform, aparam, , "Inv078 -- Control de Inventarios")
