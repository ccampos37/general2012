...
Begin VB.Form FrmEstadoOrdenes 
   Caption         =   "Form1"
   ClientHeight    =   9240
   ClientLeft      =   60
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "FrmEstadoOrdenes"
...
Private Sub Form_Load()
   ...
   TablasBasicas1.NombreTabla = "co_estadoorden"
...
Private Sub mTablaBasica1_Click(indice As Variant)
  If indice = 3 Then Call Impresion("co_EstaoddeOrdenes.rpt")
End Sub
