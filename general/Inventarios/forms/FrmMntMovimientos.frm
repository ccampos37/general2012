...
Begin VB.Form FrmMntMovimientos 
   Caption         =   "Form1"
   ClientHeight    =   8115
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin MSFlexGridLib.MSFlexGrid MSFlexGrid1 
      ...
      Rows            =   1
      Cols            =   10
      FormatString    =   $"FrmMntMovimientos.frx":0000
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   7.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmMntMovimientos"
...
Dim rsmantenimiento As New ADODB.Recordset
...
Private Sub Form_Activate()
   ...
   If DataGrid1.Row > 1 Then
      Text5 = Format(rsmantenimiento.RecordCount, "##,###,##0.00")
      kTotal = 0
      For J = 1 To rsmantenimiento.RecordCount
        kTotal = kTotal + DataGrid1.Columns(3)
      Next
...
Private Sub inicializaFG()
     ...
     Call ClsTock.CreaRsTempDetalle(rsmantenimiento)
