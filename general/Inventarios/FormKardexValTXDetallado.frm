...
Begin VB.Form FrmKardexValTXDetallado 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " Kardex Valorizado Detallado x Articulo"
   ClientHeight    =   4080
   ClientLeft      =   1470
   ClientTop       =   1590
   ClientWidth     =   5685
   Icon            =   "FormKardexValTXDetallado.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "FormKardexValTXDetallado.frx":0442
   ScaleHeight     =   4080
   ScaleWidth      =   5685
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   708
         Left            =   4200
         Picture         =   "FormKardexValTXDetallado.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   2400
         Width           =   705
      ...
      Begin VB.CommandButton CmdAceptar 
         ...
         Height          =   690
         Left            =   3360
         Picture         =   "FormKardexValTXDetallado.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   2400
         Width           =   705
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FormKardexValTXDetallado.frx":1108
         Left            =   2040
         List            =   "FormKardexValTXDetallado.frx":110A
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FormKardexValTXDetallado.frx":110C
         Left            =   1710
         List            =   "FormKardexValTXDetallado.frx":1116
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   1680
         Width           =   3150
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FormKardexValTXDetallado.frx":112A
         Left            =   2070
         List            =   "FormKardexValTXDetallado.frx":112C
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   750
         Width           =   2760
   ...
   End
End
Attribute VB_Name = "FrmKardexValTXDetallado"
