...
Begin VB.Form FrmStkAlm 
   ...
   Begin VB.ComboBox Combo2 
      Enabled         =   0   'False
      Height          =   288
      ItemData        =   "Formxxx.frx":0000
      Left            =   3840
      List            =   "Formxxx.frx":000A
...
If OpTodos.Value Then
    ...
    If Check1.Value = 0 Then
            If ChkSerie = 1 Then
                    ...
                    CrystalReport1.ReportFileName = cRutP & IIf(Combo2.ListIndex = 1, "inv142.rpt", "inv136.rpt")
            ElseIf Chkprecio = 0 Then
                    CrystalReport1.WindowTitle = "Inv078 -- Control de Inventarios"
                    CrystalReport1.ReportFileName = cRutP & "inv078.rpt"
            Else
                    CrystalReport1.WindowTitle = "Inv066-- Control de Inventarios"
                    CrystalReport1.ReportFileName = cRutP & "inv066.rpt"
            End If
    ...
    Else                                     'Consolidado
            If ChkSerie = 1 Then
                    ...
                    CrystalReport1.ReportFileName = cRutP & IIf(Combo2.ListIndex = 1, "inv143.rpt", "inv137.rpt")
            ElseIf Chkprecio = 0 Then
                    CrystalReport1.WindowTitle = "Inv079 -- Control de Inventarios"
                    CrystalReport1.ReportFileName = cRutP & "inv079.rpt"
            Else
                    CrystalReport1.WindowTitle = "Inv081 -- Control de Inventarios"
                    CrystalReport1.ReportFileName = cRutP & "inv081.rpt"
            End If
    End If
...
'
    CrystalReport1.StoredProcParam(0) = cConexCom.DefaultDatabase
...
'         Adodc2.Open "Select p.ACODIGO, p.ADESCRI,p.AUNIDAD,p.ACODIGO2 from MaeArt p, StkArt n Where n.STSKDIS<> 0 and  p.ACODIGO =  n.STCODIGO and n.STALMA = '" & almacen & "'  ", cConexCom, adOpenStatic, adLockOptimistic
...
'    Adodc2.Open "Select p.ACODIGO, p.ADESCRI,p.AUNIDAD from MaeArt p, StkArt n Where n.STSKDIS<> 0 and  p.ACODIGO =  n.STCODIGO and n.STALMA = '" & almacen & "'  ", cConexCom, adOpenStatic, adLockOptimistic
...
If OpTodos.Value Then
    ...
    If Check1.Value = 0 Then
        If Chkprecio = 0 Then
                ...
                CrystalReport1.ReportFileName = cRutP & "inv080.rpt"
        Else
                CrystalReport1.WindowTitle = "Inv070 -- Control de Inventarios"
                CrystalReport1.ReportFileName = cRutP & "inv070.rpt"
        End If
        cadena = "{STKART.STALMA}='" & almacen & "' "
    ...
    Else                                     'Consolidado
        If Chkprecio = 0 Then
                ...
                CrystalReport1.ReportFileName = cRutP & "inv089.rpt"
        Else
                CrystalReport1.WindowTitle = "Inv067 -- Control de Inventarios"
                CrystalReport1.ReportFileName = cRutP & "inv067.rpt"
        End If
     End If
     Ubi_Tab CrystalReport1
     CrystalReport1.DiscardSavedData = True
...
If Check1.Value = 1 Then
        'CrystalReport1.ReportFileName =  cRutP & "stkxfcon.rpt"
        If Chkprecio = 0 Then
                CrystalReport1.WindowTitle = "Inv089 -- Control de Inventarios"
                CrystalReport1.ReportFileName = cRutP & "inv089.rpt"
        Else
        ...
        End If
Else
        '.ReportFileName =  cRutP & "stkxfam.rpt"
        If Chkprecio = 0 Then
                CrystalReport1.WindowTitle = "Inv080 -- Control de Inventarios"
                CrystalReport1.ReportFileName = cRutP & "inv080.rpt"
        Else
