...
cadena = "{LISTA_PRECIOS.Cod_LisPre}='" & List & "' and {STKART.STALMA}='" & VGAlma & "'"
...
SQL = SQL & "Where Stalma='" & VGAlma & "' And COD_LISPRE='" & List & "'"
...
If OpTodos.Value Then
    ...
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv045 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv045.rpt"
...
If OpTodos.Value Then
    ...
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv046 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv046.rpt"
    Ubi_Tab CrystalReport1
    CrystalReport1.DiscardSavedData = True
    CrystalReport1.SelectionFormula = cadena
    CrystalReport1.Formulas(0) = "emp = '" & VGNemp & "'"
...
If OpTodos.Value Then
    ...
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv047 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv047.rpt"
    Ubi_Tab CrystalReport1
    CrystalReport1.DiscardSavedData = True
    CrystalReport1.SelectionFormula = cadena
    CrystalReport1.Formulas(0) = "emp = '" & VGNemp & "'"
...
If OpTodos.Value Then
    ...
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv049 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv049.rpt"
    Ubi_Tab CrystalReport1
    CrystalReport1.DiscardSavedData = True
    CrystalReport1.SelectionFormula = cadena
    CrystalReport1.Formulas(0) = "emp = '" & VGNemp & "'"
...
cadena = "{LISTA_PRECIOS.Cod_LisPre}='" & List & "' "
...
If OpTodos.Value Then
    ...
    If Adodc3.RecordCount > 0 Then
      ...
      End If
    Else
      MsgBox "No existen stock de artículos para esta Lista de Precio", vbOKOnly, "Aviso"
      Adodc3.Close
      Screen.MousePointer = 1
      Exit Sub
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv048 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv048.rpt"
    Ubi_Tab CrystalReport1
    CrystalReport1.DiscardSavedData = True
    CrystalReport1.SelectionFormula = cadena
    CrystalReport1.Formulas(0) = "emp = '" & VGNemp & "'"
...
If OpTodos.Value Then
    ...
    End If
    Adodc3.Close
    CrystalReport1.WindowTitle = "Inv050 -- Control de Inventarios"
    CrystalReport1.ReportFileName = cRutP & "inv050.rpt"
    Ubi_Tab CrystalReport1
    CrystalReport1.DiscardSavedData = True
    CrystalReport1.SelectionFormula = cadena
    CrystalReport1.Formulas(0) = "emp = '" & VGNemp & "'"
