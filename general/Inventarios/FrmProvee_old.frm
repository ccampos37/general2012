...
Begin VB.Form FrmProvee 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmProvee.frx":08CA
         Left            =   5265
         List            =   "FrmProvee.frx":08D4
...
Select Case nCom
Case 0
    adodc1.Open "Select PRVCCODIGO,PRVCNOMBRE,PRVCDIRECC,PRVCTELEF1 FROM MAEPROV ORDER BY PRVCCODIGO", cConexCom, adOpenStatic
Case 1
    adodc1.Open "Select PRVCCODIGO,PRVCNOMBRE,PRVCDIRECC,PRVCTELEF1 FROM MAEPROV ORDER BY PRVCNOMBRE", cConexCom, adOpenStatic
End Select
TxFiltro = ""
        ...
        Else
            ...
            Dim Nombre As String
               If Not adodc1.EOF Then
                  ...
                  cSel1.Open cSql1, cConexCont, adOpenStatic
    ...
    If UCase(Dir$(cBase)) = VGNameCont & ".MDB" Then
      'Se hace un enlace con los archivos de contabilidad, se busca y se graba
       If Not adodc1.EOF Then
          ...
          cSel2.Open cSql1, cConexCom, adOpenStatic
...
GrabErr:
    MsgBox Err.Description
    If nTra = 1 Then cConexCom.RollbackTrans
    If nTra2 = 1 Then cConexCom.RollbackTrans
End Sub
...
If Index = 6 Then
        ...
        Adodc3.Open "SELECT TCLAVE,TDESCRI FROM TabAYU where  TCOD = '62'", cConexCom, adOpenStatic, adLockOptimistic
