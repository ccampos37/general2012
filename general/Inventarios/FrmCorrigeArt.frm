...
Private Sub importarExcel(Tabla As Recordset)
    ...
    Set xLibro = objExcel.Workbooks.Open("" & Text6.text & "")
  
    'Hacemos el Excel Visible
    objExcel.Visible = True
    Set DataGrid2.DataSource = Tabla
    With xLibro
    ...
    Label24.Caption = Tabla.RecordCount
