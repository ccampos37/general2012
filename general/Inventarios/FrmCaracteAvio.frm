...
Begin VB.Form FrmCaracteAvio 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Caracteristica de Avio"
   ClientHeight    =   4110
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7125
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmCaracteAvio.frx":0000
         Left            =   5040
         List            =   "FrmCaracteAvio.frx":000A
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmCaracteAvio.frx":0027
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmCaracteAvio.frx":0469
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   2520
         Picture         =   "FrmCaracteAvio.frx":08AB
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   675
         Left            =   5760
         Picture         =   "FrmCaracteAvio.frx":0CED
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   255
         Width           =   775
      ...
      Begin VB.CommandButton command5 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "FrmCaracteAvio.frx":112F
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
         Visible         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "FrmCaracteAvio.frx":1571
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command9 
         ...
         Height          =   675
         Left            =   3945
         Picture         =   "FrmCaracteAvio.frx":19B3
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   255
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmCaracteAvio"
...
If KeyAscii = 13 Then
    If Trim(Text1) <> "" Then
       If Existe(1, Trim(Text1), "caracteristica_a", "CodCar", False, Right(cbo_Familia.text, 2), "CodFam") Then
          MsgBox "El código de Caracteristica de Avios ya existe", vbInformation, "Mensaje"
          'cbo_Familia.text = ""
...
'If rs.RecordCount > 0 Then
    If Trim(TxFiltro) <> "" Then
        If CmbOrden.ListIndex = 0 Then
            nstr = "CodCar like '" & Trim(UCase(TxFiltro)) & "%'"
        ElseIf CmbOrden.ListIndex = 1 Then
            nstr = "descripcion like '" & Trim(UCase(TxFiltro)) & "%'"
        End If
        nstr = "select * from caracteristica_a where " & nstr
    Else
       nstr = "select * from caracteristica_a where codcar<>'00'"
    End If
'Else
'    nstr = "select * from Caracteristica"
'End If
Call Listado(nstr)
End Sub
...
Select Case nCom
Case 0
    Data1.RecordSource = "Select * from caracteristica_a where codcar<>'00' order by CodCar"
    
Case 1
    Data1.RecordSource = "Select * from caracteristica_a where codcar<>'00' order by DESCRIPCIOn"
End Select
TxFiltro = ""
Data1.Refresh
...
Private Sub Command1_Click()
   ...
   Frame3.Caption = "Ingreso de Caracteristica de Avios"
...
If rs.RecordCount > 0 Then
   Limpiar
    resp = "N"
    Frame3.Caption = "Modificación de Caracteristica de Avios"
    DBGrid1.Visible = False
    'Command19.Visible = False
    Frame2.Visible = False
    Frame5.Visible = False
...
'       If MsgBox("La Caracteristica seleccionada tiene registrada Lineas, al Eliminarla eliminará sus Lineas, desea Eliminarla de todas maneras", vbYesNo, "Eliminacion de Registro") = vbNo Then
...
'    cSelA.Close
    ...
    If MsgBox("Seguro de Eliminar", vbQuestion + vbOKCancel, "Inventarios") = vbOK Then
        'If Existe(1, rs.Fields("CODIGO"), "MaeArt", "ACaracteristica", False) Then
        '    MsgBox "El Titulo de Tela no puede Eliminarse, porque esta registrada en Articulos"
        'Else
            nTra = 2
            cCodigo1 = Pos_Dato1(rs, "CodCar")
            nTra = 1
            'Vgcnx.BeginTrans
            'Vgcnx.Execute cSql1
            'Vgcnx.Execute CSQL2
            ...
            Call Listado("select * from caracteristica_a where codcar<>'00'")
        'End If
    End If
    DBGrid1.Refresh
...
If resp = "S" Then
  If Trim(Text1) = "" Then
     MsgBox "Ingrese Código de Caracteristica de Avios", vbInformation, "Mensaje"
     Text1.SetFocus
     Exit Sub
  Else
       If VGDllGeneral.VerificaDatoExistente(VGCNx, "select * from caracteristica_a where CodCar='" & Trim(Text1) & "' AND CodFam='" & Right(cbo_Familia.text, 2) & "' ") = 1 Then
          MsgBox "El código de Caracteristica de Avios ya existe", vbInformation, "Mensaje"
          Text1.SetFocus
          Exit Sub
       End If
...
End If
  ...
  If Trim(Text2) = "" Then
     MsgBox "Ingrese Descripción de Caracteristica de Avios", vbExclamation, "Aviso"
     Text2.SetFocus
     Exit Sub
  End If
...
'  End If
    If resp = "S" Then
        VGCNx.Execute "Insert Into caracteristica_a " & _
                          "(CodCar,codfam,descripcion)" & _
                          " VALUES(" & _
                          "'" & Trim(Text1.text) & "'," & _
        ...
        Text1.SetFocus
    Else
        VGCNx.Execute "UPDATE caracteristica_a " & _
                          " SET descripcion='" & SupCadSQL(Text2.text) & "'" & _
                          " WHERE CodCar='" & Text1.text & "' and CodFam='" & Right(cbo_Familia.text, 2) & "' "
...
central Me
Call Listado("Select * from caracteristica_a where codcar<>'00'order by CodCar")


'   carga familia
    Set RsFam = New ADODB.Recordset
    
    SQL = "select * from familia_A where codfam<>'99' order by descripcion"
    RsFam.Open SQL, VGCNx, adOpenStatic
    'Set RsFam = Coneccion.Execute(SQL)
    While Not RsFam.EOF
        cbo_Familia.AddItem RsFam!descripcion + Space(100) + RsFam!CodFam
        RsFam.MoveNext
    Wend
    RsFam.Close
...
If KeyAscii = 13 Then
    If Trim(Text2) = "" Then
       MsgBox "Ingrese Descripcion de la Caracteristica de Avios ", vbInformation, "Mensaje"
