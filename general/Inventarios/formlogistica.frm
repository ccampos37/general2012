...
Begin VB.Form Formlogistica 
   Caption         =   "Reposición de Stock"
   ClientHeight    =   6240
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8805
   Icon            =   "formlogistica.frx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6240
   ScaleWidth      =   8805
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "formlogistica.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   600
         Picture         =   "formlogistica.frx":0D0C
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   3000
         Picture         =   "formlogistica.frx":114E
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   240
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command19 
         ...
         Height          =   675
         Left            =   7596
         Picture         =   "formlogistica.frx":1590
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   252
         Width           =   775
   ...
   End
End
Attribute VB_Name = "Formlogistica"
