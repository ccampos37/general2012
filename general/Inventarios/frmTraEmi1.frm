...
Private Sub txtCod_DblClick()
    ...
    If frmTraEmi.txtNSol <> "" Then
      strsql = "SELECT sccodigo,scdescri,scunidad, tipsol FROM scd001 where scnumdoc='" & frmTraEmi.txtNSol & "' "
 ...
 On Error GoTo Err
    If KeyAscii = 13 Then
        ...
        If txtCod <> "" Then
            ...
            Else
               If frmTraEmi.txtNSol <> "" Then
                  adoreg.Open "Select sccantid,tipsol from scd001 where scnumdoc='" & frmTraEmi.txtNSol & "' and sccodigo='" & txtCod & "'", VGcnx, adOpenStatic, adLockPessimistic
