...
Begin VB.Form FrmMezclaTela 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmMezclaTela.frx":0000
         Left            =   5040
         List            =   "FrmMezclaTela.frx":000A
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmMezclaTela.frx":0027
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmMezclaTela.frx":0469
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   2520
         Picture         =   "FrmMezclaTela.frx":08AB
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   675
         Left            =   5760
         Picture         =   "FrmMezclaTela.frx":0CED
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   255
         Width           =   775
      ...
      Begin VB.CommandButton command5 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "FrmMezclaTela.frx":112F
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
         Visible         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "FrmMezclaTela.frx":1571
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command9 
         ...
         Height          =   675
         Left            =   3945
         Picture         =   "FrmMezclaTela.frx":19B3
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   255
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmMezclaTela"
...
cNomRepor = "Mezclatela.RPT"
If Trim(cNomRepor) <> "" Then
    CrystalReport1.Reset
    CrystalReport1.WindowTitle = "Reporte de Mezcla de Tela"
...
'If rs.RecordCount > 0 Then
    If Trim(TxFiltro) <> "" Then
        ...
        End If
        nstr = "select * from Mezcla where " & nstr
    Else
       nstr = "select * from Mezcla"
    End If
'Else
...
Select Case nCom
Case 0
    Data1.RecordSource = "Select * from Mezcla order by CODIGO"
    
Case 1
    Data1.RecordSource = "Select * from Mezcla order by DESCRIPCIO"
End Select
TxFiltro = ""
Data1.Refresh
...
Private Sub Command1_Click()
   ...
   Frame3.Caption = "Ingreso de Mezcla de Telas"
...
If rs.RecordCount > 0 Then
   Limpiar
    resp = "N"
    Frame3.Caption = "Modificación de Mezcla de Tela"
    DBGrid1.Visible = False
    'Command19.Visible = False
    Frame2.Visible = False
    Frame5.Visible = False
...
'    cSelA.Close
    ...
    If MsgBox("Seguro de Eliminar", vbQuestion + vbOKCancel, "Inventarios") = vbOK Then
        ...
        '    MsgBox "El Mezcla de Tela no puede Eliminarse, porque esta registrada en Articulos"
        'Else
            nTra = 2
            ...
            Call Listado("select * from Mezcla")
        'End If
    End If
    DBGrid1.Refresh
...
If resp = "S" Then
  If Trim(Text1) = "" Then
     MsgBox "Ingrese Código de Mezcla de Tela", vbInformation, "Mensaje"
     Text1.SetFocus
     Exit Sub
  Else
       If VGDllGeneral.VerificaDatoExistente(VGCNx, "select * from Mezcla where CODIGO='" & Trim(Text1) & "'") = 1 Then
          MsgBox "El código de Mezcla de tela ya existe", vbInformation, "Mensaje"
          Text1.SetFocus
          Exit Sub
       End If
  End If
End If
  ...
  If Trim(Text2) = "" Then
     MsgBox "Ingrese Descripción de Mezcla de Tela", vbExclamation, "Aviso"
     Text2.SetFocus
     Exit Sub
  End If
...
'  End If
    If resp = "S" Then
        VGCNx.Execute "Insert Into Mezcla " & _
                          "(CODIGO,descripcio)" & _
                          " VALUES(" & _
                          "'" & Trim(Text1.text) & "'," & _
...
central Me
Call Listado("Select * from Mezcla order by CODIGO")
'Command19.Visible = True
End Sub
...
If KeyAscii = 13 Then
    If Trim(Text1) <> "" Then
       If Existe(1, Trim(Text1), "Mezcla", "CODIGO", False) Then
          MsgBox "El código de Mezcla de Tela  ya existe", vbInformation, "Mensaje"
...
If KeyAscii = 13 Then
    If Trim(Text2) = "" Then
       MsgBox "Ingrese Descripcion de Mezcla de Tela ", vbInformation, "Mensaje"
