...
Begin VB.Form FrmConsumoCCosto 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consumo por Centro De Costos"
   ClientHeight    =   4605
   ClientLeft      =   1470
   ClientTop       =   1590
   ClientWidth     =   5355
   Icon            =   "FrmConsumoCCosto.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "FrmConsumoCCosto.frx":0442
   ScaleHeight     =   4605
   ScaleWidth      =   5355
   ...
   Begin VB.CommandButton CmdAceptar 
      ...
      Height          =   690
      Left            =   1728
      Picture         =   "FrmConsumoCCosto.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   3672
      Width           =   705
   ...
   Begin VB.CommandButton CmdSalir 
      ...
      Height          =   708
      Left            =   2616
      Picture         =   "FrmConsumoCCosto.frx":0CC6
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   3672
      Width           =   705
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo4 
         Height          =   315
         ItemData        =   "FrmConsumoCCosto.frx":1108
         Left            =   1710
         List            =   "FrmConsumoCCosto.frx":1115
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FrmConsumoCCosto.frx":1157
         Left            =   1710
         List            =   "FrmConsumoCCosto.frx":1161
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   1200
         Width           =   2790
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmConsumoCCosto.frx":1175
         Left            =   1710
         List            =   "FrmConsumoCCosto.frx":1177
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   390
         Width           =   2760
   ...
   End
End
Attribute VB_Name = "FrmConsumoCCosto"
...
'*****************************************************************
  ...
  CrystalReport1.ReportFileName = VGParamSistem.RutaReport & "inv132.rpt"
...
cSql1 = cSql1 & "  And CASITGUI<>'A'  AND not (CATD='GS' And CACODMOV='GF' And CASITGUI='F') Order By DECENCOS,DECODIGO,CAFECDOC,CAHORA "
