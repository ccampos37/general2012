...
Begin VB.Form FrmAnchoTela 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmAnchoTela.frx":0000
         Left            =   5040
         List            =   "FrmAnchoTela.frx":000A
   ...
   End
End
Attribute VB_Name = "FrmAnchoTela"
...
cNomRepor = "Anchotela.RPT"
If Trim(cNomRepor) <> "" Then
    CrystalReport1.Reset
    CrystalReport1.WindowTitle = "Reporte de Ancho de Tela"
...
'If rs.RecordCount > 0 Then
    If Trim(TxFiltro) <> "" Then
        ...
        End If
        nstr = "select * from ancho_medida where " & nstr
    Else
       nstr = "select * from ancho_medida"
    End If
'Else
...
Select Case nCom
Case 0
    Data1.RecordSource = "Select * from ancho_medida order by CODIGO"
    
Case 1
    Data1.RecordSource = "Select * from ancho_medida order by DESCRIPCIO"
End Select
TxFiltro = ""
Data1.Refresh
...
Private Sub Command1_Click()
   ...
   Frame3.Caption = "Ingreso de Ancho de Telas"
...
If rs.RecordCount > 0 Then
   Limpiar
    resp = "N"
    Frame3.Caption = "Modificación de Ancho de Tela"
    DBGrid1.Visible = False
    'Command19.Visible = False
    Frame2.Visible = False
    Frame5.Visible = False
...
'    cSelA.Close
    ...
    If MsgBox("Seguro de Eliminar", vbQuestion + vbOKCancel, "Inventarios") = vbOK Then
        ...
        '    MsgBox "El Ancho de Tela no puede Eliminarse, porque esta registrada en Articulos"
        'Else
            nTra = 2
            ...
            Call Listado("select * from ancho_medida")
        'End If
    End If
    DBGrid1.Refresh
...
If resp = "S" Then
  If Trim(Text1) = "" Then
     MsgBox "Ingrese Código de Ancho de Tela", vbInformation, "Mensaje"
     Text1.SetFocus
     Exit Sub
  Else
       If VGDllGeneral.VerificaDatoExistente(VGCNx, "select * from ancho_medida where CODIGO='" & Trim(Text1) & "'") = 1 Then
          MsgBox "El código de Ancho de tela ya existe", vbInformation, "Mensaje"
          Text1.SetFocus
          Exit Sub
       End If
  End If
End If
  ...
  If Trim(Text2) = "" Then
     MsgBox "Ingrese Descripción de Ancho de Tela", vbExclamation, "Aviso"
     Text2.SetFocus
     Exit Sub
  End If
...
'  End If
    If resp = "S" Then
        VGCNx.Execute "Insert Into ancho_medida " & _
                          "(CODIGO,descripcio)" & _
                          " VALUES(" & _
                          "'" & Trim(Text1.text) & "'," & _
        ...
        Text1.SetFocus
    Else
        VGCNx.Execute "UPDATE ancho_medida " & _
...
central Me
Call Listado("Select * from ancho_medida order by CODIGO")
'Command19.Visible = True
End Sub
...
If KeyAscii = 13 Then
    If Trim(Text1) <> "" Then
       If Existe(1, Trim(Text1), "ancho_medida", "CODIGO", False) Then
          MsgBox "El código de Ancho de Tela  ya existe", vbInformation, "Mensaje"
...
If KeyAscii = 13 Then
    If Trim(Text2) = "" Then
       MsgBox "Ingrese Descripcion de Ancho de Tela ", vbInformation, "Mensaje"
