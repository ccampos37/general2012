...
Begin VB.Form frmReferencia 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   675
      Left            =   2280
      Picture         =   "frmReferencia.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4470
      Width           =   775
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   675
      Left            =   4200
      Picture         =   "frmReferencia.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4470
      Width           =   775
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "frmReferencia.frx":0884
      Left            =   5160
      List            =   "frmReferencia.frx":088E
...
If Adodc3.RecordCount <> 0 Then
  If Not IsNull(DataGrid1.Bookmark) Then Adodc3.Bookmark = DataGrid1.Bookmark

  vGUtil(1) = IIf(IsNull(Adodc3.Fields(0)), "", Adodc3.Fields(0))
  vGUtil(2) = IIf(IsNull(Adodc3.Fields(1)), "", Adodc3.Fields(1))
  If Label1.Caption = "Transacciones" Then
    vGUtil(3) = IIf(IsNull(Adodc3.Fields(1)), "", Adodc3.Fields(2))
  End If
Else
  vGUtil(1) = ""
  vGUtil(2) = ""
...
Select Case Combo1.ListIndex
 Case 0:
        Set Adodc3 = VGCNx.Execute(csql & " ORDER BY " & Campos(1))
        Set DataGrid1.DataSource = Adodc3
        DataGrid1.Refresh
        Text1 = ""
 Case 1:
        Adodc3.Open csql & " ORDER BY " & Campos(2), VGCNx, adOpenDynamic, adLockOptimistic
        Set DataGrid1.DataSource = Adodc3
        DataGrid1.Refresh
        Text1 = ""
 Case 2:
        Adodc3.Open csql & " ORDER BY " & Campos(4), VGCNx, adOpenDynamic, adLockOptimistic
        Set DataGrid1.DataSource = Adodc3
        DataGrid1.Refresh
        Text1 = ""
End Select
...
Private Sub Form_Load()
 ...
 'Me.Top = MDIPrincipal.Height - MDIPrincipal.ScaleHeight
 AlinearAyuda Me
