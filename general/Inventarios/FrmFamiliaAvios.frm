...
Begin VB.Form FrmFamiliaAvios 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmFamiliaAvios.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmFamiliaAvios.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   2520
         Picture         =   "FrmFamiliaAvios.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   675
         Left            =   5760
         Picture         =   "FrmFamiliaAvios.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   255
         Width           =   775
      ...
      Begin VB.CommandButton command5 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "FrmFamiliaAvios.frx":1108
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
         Visible         =   0   'False
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmFamiliaAvios.frx":154A
         Left            =   5040
         List            =   "FrmFamiliaAvios.frx":1554
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "FrmFamiliaAvios.frx":1571
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command9 
         ...
         Height          =   675
         Left            =   3945
         Picture         =   "FrmFamiliaAvios.frx":19B3
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   255
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmFamiliaAvios"
...
cNomRepor = "FamiliaAvios.RPT"
If Trim(cNomRepor) <> "" Then
    CrystalReport1.Reset
    CrystalReport1.WindowTitle = "Reporte de Familia de Avios"
...
'If rs.RecordCount > 0 Then
    If Trim(TxFiltro) <> "" Then
        If CmbOrden.ListIndex = 0 Then
            nstr = "CODfam like '" & Trim(UCase(TxFiltro)) & "%'"
        ElseIf CmbOrden.ListIndex = 1 Then
            nstr = "descripcion like '" & Trim(UCase(TxFiltro)) & "%'"
        End If
        nstr = "select * from familia_A where " & nstr
    Else
       nstr = "select * from familia_A"
    End If
'Else
...
Select Case nCom
Case 0
    Data1.RecordSource = "Select * from familia_A order by codfam"
    
Case 1
    Data1.RecordSource = "Select * from familia_A order by DESCRIPCIOn"
End Select
TxFiltro = ""
Data1.Refresh
...
Private Sub Command1_Click()
   ...
   Frame3.Caption = "Ingreso de Familia de Avios"
...
If rs.RecordCount > 0 Then
   Limpiar
    resp = "N"
    Frame3.Caption = "Modificación de Familia de Avios"
    DBGrid1.Visible = False
    'Command19.Visible = False
    Frame2.Visible = False
    Frame5.Visible = False
...
If rs.RecordCount > 0 Then
    ...
    If MsgBox("Seguro de Eliminar", vbQuestion + vbOKCancel, "Inventarios") = vbOK Then
        ...
        'Else
            nTra = 2
            cCodigo1 = Pos_Dato1(rs, "CODfam")
            nTra = 1
            nTra = 0
            
            Call Listado("select * from familia_A")
        'End If
    End If
    DBGrid1.Refresh
...
If resp = "S" Then
  If Trim(Text1) = "" Then
     ...
     Exit Sub
  Else
       If VGDllGeneral.VerificaDatoExistente(VGCNx, "select * from familia_A where CODfam='" & Trim(Text1) & "'") = 1 Then
          MsgBox "El código de Familia de Avios ya existe", vbInformation, "Mensaje"
          Text1.SetFocus
          Exit Sub
       End If
  End If
End If
  ...
  If Trim(Text2) = "" Then
     MsgBox "Ingrese Descripción de Familia de Avios", vbExclamation, "Aviso"
     Text2.SetFocus
     Exit Sub
  End If
...
'  End If
    If resp = "S" Then
        VGCNx.Execute "Insert Into familia_A " & _
                          "(CODfam,descripcion)" & _
                          " VALUES(" & _
                          "'" & Trim(Text1.text) & "'," & _
        ...
        Text1.SetFocus
    Else
        VGCNx.Execute "UPDATE familia_A " & _
                          " SET descripcion='" & SupCadSQL(Text2.text) & "'" & _
                          " WHERE CODfam='" & Text1.text & "'"
...
central Me
Call Listado("Select * from familia_A order by CODfam")
'Command19.Visible = True
End Sub
...
If KeyAscii = 13 Then
    If Trim(Text1) <> "" Then
       If Existe(1, Trim(Text1), "familia_A", "codfam", False) Then
          MsgBox "El código de Familia de Avios ya existe", vbInformation, "Mensaje"
...
If KeyAscii = 13 Then
    If Trim(Text2) = "" Then
       MsgBox "Ingrese Descripcion de la Familia de Avios ", vbInformation, "Mensaje"
