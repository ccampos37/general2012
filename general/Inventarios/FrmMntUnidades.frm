...
Begin VB.Form FrmArUnidades 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox CmbOrden 
         Height          =   315
         ItemData        =   "FrmMntUnidades.frx":0000
         Left            =   5040
         List            =   "FrmMntUnidades.frx":000A
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton command5 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "FrmMntUnidades.frx":0027
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   675
         Left            =   5760
         Picture         =   "FrmMntUnidades.frx":0469
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   255
         Width           =   775
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   675
         Left            =   2520
         Picture         =   "FrmMntUnidades.frx":08AB
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmMntUnidades.frx":0CED
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmMntUnidades.frx":112F
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command19 
         ...
         Height          =   675
         Left            =   4680
         Picture         =   "FrmMntUnidades.frx":1571
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   240
         Width           =   775
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command9 
         ...
         Height          =   675
         Left            =   3960
         Picture         =   "FrmMntUnidades.frx":3D13
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   240
         Width           =   775
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   675
         Left            =   1800
         Picture         =   "FrmMntUnidades.frx":4155
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
         Width           =   775
...
Set rs = cn.Execute("select * from tabunimed")
DBGrid1.SetFocus
End Sub
...
If rs.RecordCount > 0 Then
    ...
    If MsgBox("Seguro de Eliminar", vbQuestion + vbOKCancel, mensaje1) = vbOK Then
            ...
            nTra = 0
            Set rs = cn.Execute("Select * from TABUNIMED  order by UM_ABREV")
            Call listado("")
    End If
    DBGrid1.Refresh
...
End If
  ...
  End If
    ...
    If resp = "S" Then
         cConexCom.Execute "INSERT INTO TABUNIMED " & _
        ...
        Text1.SetFocus
    Else
       cConexCom.Execute "UPDATE TABUNIMED " & _
...
'  Set rs = cn.Execute(wcad)
  If Trim(TxFiltro) <> "" And TxFiltro.Visible Then
         Select Case CmbOrden.ListIndex
        Case 0
            Set rs = cn.Execute("SELECT * FROM TABUNIMED WHERE UM_ABREV LIKE '%" & wcad & "' ORDER BY 1")
        Case 1
            Set rs = cn.Execute("SELECT * FROM TABUNIMED WHERE UM_NOMBRE LIKE '%" & wcad & "' ORDER BY 2 ")
        End Select
        If rs.EOF Then Set rs = cn.Execute("SELECT * FROM TABUNIMED ")
 Else
        Select Case CmbOrden.ListIndex
        Case 0
            Set rs = cn.Execute("SELECT * FROM TABUNIMED ORDER BY 1")
        Case 1
            Set rs = cn.Execute("SELECT * FROM TABUNIMED ORDER BY 2 ")
        End Select
 End If
