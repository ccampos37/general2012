...
Begin VB.Form FrmPedidoVentanilla 
   ...
   ClientTop       =   330
   ClientWidth     =   12165
   Icon            =   "FrmPedidoVentanilla.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPedidoVentanilla.frx":000C
      ...
      TabPicture(1)   =   "FrmPedidoVentanilla.frx":0028
      ...
      Tab(1).Control(6)=   "cmdBotones(12)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "cmdBotones(11)"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "Fr4"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).ControlCount=   9
      TabCaption(2)   =   "Ingreso Masivo"
      TabPicture(2)   =   "FrmPedidoVentanilla.frx":0044
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   1005
         Left            =   -69510
         Picture         =   "FrmPedidoVentanilla.frx":0060
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   585
         Width           =   1140
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   150
            Picture         =   "FrmPedidoVentanilla.frx":0970
            Top             =   210
            Width           =   480
         End
      ...
      Begin VB.Frame Fr1 
         ...
         Begin VB.Image Image2 
            Height          =   540
            Left            =   270
            Picture         =   "FrmPedidoVentanilla.frx":0DB2
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
         Begin VB.Image Image3 
            Height          =   540
            Left            =   2430
            Picture         =   "FrmPedidoVentanilla.frx":15CA
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame Fr5 
            ...
            Begin VB.Image Image5 
               Height          =   540
               Left            =   2295
               Picture         =   "FrmPedidoVentanilla.frx":1BF9
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
            Begin VB.Image Image4 
               Height          =   540
               Left            =   270
               Picture         =   "FrmPedidoVentanilla.frx":2029
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
...
'       End If
       ...
       If ExisteElem(0, VGCNx, "##xx_ventas") Then Set xsql = VGCNx.Execute("drop table ##xx_ventas")
        ...
        FrmAyudaPedidos.BTabla = " ##xx_ventas"
       ...
       Else
          If VGParamSistem.stockcomp = 1 Then
             If VGParamSistem.kitvirtual = 1 Then
               ...
               Else
                 FrmAyudaPedidos.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,stskdis-stskcom as Stock"
                 'FrmAyudaPedidos.BCampos = "acodigo as Codigo,adescri as Descripcion,stskdis-stskcom as Stock"
             End If
           Else
             FrmAyudaPedidos.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,stskdis as Stock"
          End If
       End If
...
Private Sub cBoton_Click(Index As Integer)
  ...
  If Index = 0 Then
       ...
       LblTicSer.Caption = g_ticserieb & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='" & g_tipoticketB & "' and puntovtadocserie='" & g_ticserieb & "' and puntovtacodigo='" & g_ptoventa & "' and empresacodigo='" & VGParametros.empresacodigo & "'", VGCNx), 8)
        ...
        ElseIf cOpc2(3).Value Or cOpc2(4).Value Then
          ...
          End If
             If cOpc2(3).Value Then
                MBox(3) = g_ticserieb & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where  empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoticketB & "' and puntovtadocserie='" & g_ticserieb & "' and puntovtacodigo='" & g_ptoventa & "' ", VGCNx), 8) ' MBox(1).MaxLength)
            ...
            If cOpc2(4).Value Then
                MBox(3) = g_ticserief & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where  empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoticketf & "' and puntovtadocserie='" & g_ticserief & "' and puntovtacodigo='" & g_ptoventa & "' ", VGCNx), 8) ' MBox(1).MaxLength)
