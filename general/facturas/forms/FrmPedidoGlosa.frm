...
Begin VB.Form FrmPedidoGlosa 
   ...
   Caption         =   "Pedido glosa"
   ClientHeight    =   8355
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12480
   Icon            =   "FrmPedidoGlosa.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(1)=   "TDBGrid1"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "Fr2(2)"
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   1005
         Left            =   -69510
         Picture         =   "FrmPedidoGlosa.frx":0060
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   585
         Width           =   1140
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   150
            Picture         =   "FrmPedidoGlosa.frx":0970
            Top             =   210
            Width           =   480
         End
      ...
      Begin VB.Frame Fr1 
         ...
         Begin VB.Image Image2 
            Height          =   540
            Left            =   270
            Picture         =   "FrmPedidoGlosa.frx":0DB2
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
         Begin VB.Image Image3 
            Height          =   540
            Left            =   2430
            Picture         =   "FrmPedidoGlosa.frx":15CA
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         Begin VB.Frame Fr2 
            ...
            Begin ctrlayuda_f.Ctr_Ayuda Ctr_Ayuda3 
               ...
               ListaCampos     =   "taalma(1),tadescri(1),stockenlinea(1), puntovtacodigo(1)"
               XcodCampo       =   "taalma"
               XListCampo      =   "tadescri"
               ListaCamposDescrip=   "Codigo,Descripcion,Stock en linea, Punto Vta"
               ListaCamposText =   "taalma,tadescri,stockenlinea,puntovtacodigo"
            End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame Fr5 
            ...
            Begin VB.Image Image5 
               Height          =   540
               Left            =   2295
               Picture         =   "FrmPedidoGlosa.frx":1BF9
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
            Begin VB.Image Image4 
               Height          =   540
               Left            =   270
               Picture         =   "FrmPedidoGlosa.frx":2029
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
   ...
   End
End
Attribute VB_Name = "FrmPedidoGlosa"
...
Else
   reporte = "vt_bolimpresa_" & VGCNx.DefaultDatabase & VGParametros.empresacodigo & ".rpt"
End If
...
Dim SQL As String
Dim formulas(1) As Variant, Param(4) As Variant
        Param(0) = VGParamSistem.BDEmpresa
       ...
       ' VGcnx.Execute "delete from gtempfile2filas"
        ...
        If rb.RecordCount > 0 Then
           ...
           Do While contador < numguias
              ...
              nguia = g_pedserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='GR' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10)
...
Dim xsql As New ADODB.Recordset
  ...
  ElseIf Index = 3 Then                             ' Ayuda de Productos
       ...
       Else
          If VGParamSistem.stockcomp = 1 Then
             If VGParamSistem.kitvirtual = 1 Then
                 FrmAyudaPedidos.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,stskdis-stskcom as Stock"
               Else
                 FrmAyudaPedidos.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,stskdis-stskcom as Stock"
             End If
           Else
             FrmAyudaPedidos.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,Stock=CASE WHEN AFSTOCK=0 THEN 999 ELSE stskdis END "
          End If
       End If
       ...
       If modoventa.ctrlinventario = "1" Then
          If VGParamSistem.stockcomp = 1 Then
             If VGParamSistem.kitvirtual = 1 Then
                FrmAyudaPedidos.BCondi = ""  ' stalma='" & Ctr_Ayuda3.xclave & "'"
              Else
                FrmAyudaPedidos.BCondi = "stalma='" & Ctr_Ayuda3.xclave & "' and stskdis-stskcom>0"
            End If
           Else
            If Chkentrega.Value = 1 Then
               ...
               End If
             Else
                  FrmAyudaPedidos.BCondi = "( AFSTOCK=0 OR ( stalma='" & Ctr_Ayuda3.xclave & "' and STSKDIS> 0 )  ) "
           End If
          End If
       Else
          FrmAyudaPedidos.BCondi = " isnull(stskdis,0) >=0  "
       End If
...
Private Sub cBoton_Click(Index As Integer)
  ...
  If Index = 0 Then
       ...
       MBox(4) = g_guiaserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='" & g_tipoguia & "' and puntovtadocserie='" & g_guiaserie & "' and puntovtacodigo='" & g_ptoventa & "' and empresacodigo='" & VGParametros.empresacodigo & "'", VGCNx), 10)
       MBox(12) = g_GuiaRemSerie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='" & g_tipoguiaRem & "' and puntovtadocserie='" & g_GuiaRemSerie & "' and puntovtacodigo='" & g_ptoventa & "' and empresacodigo='" & VGParametros.empresacodigo & "'", VGCNx), 10)
...
Private Sub cmdBotones_Click(Index As Integer)
   ...
   Select Case Index
    Case 0
        ...
        If cOpc(0).Enabled = True Then cOpc(0).SetFocus
        g_TipoMovi = 1
        masivo = 0
'        rsmasivo.Reset
...
Private Sub cSeleccion_Click(Index As Integer)
  ...
  If Index = 0 Then
   ...
   If Len(Trim(Ctr_Ayuoperacion.xclave)) = 0 Then
        MsgBox "Falta seleccionar operacion.", vbInformation, "ZIYAZ"
        Ctr_Ayuoperacion.SetFocus
        Exit Sub
    End If
   ...
   If cOpc2(0).Value And dllgeneral.VerificaDatoExistente(VGCNx, "select * from vt_cliente where clientecodigo='" & Ctr_Ayuda1.xclave & "' and len(ltrim(clienteruc))=11") = 0 Then
    ...
    Else
        ...
        If rsel.RecordCount > 0 Then
           ...
           MBox3(3) = Left(Escadena(rsel!clientedireccion), 64)
           MBox3(4) = Left(Escadena(rsel!clientedistrito), 64)
        End If
        rsel.Close
        Set rsel = Nothing
    End If
    ...
    nflag = 1
    If (cOpc2(0).Value Or cOpc2(1).Value Or cOpc2(2).Value Or cOpc2(3).Value Or cOpc2(4).Value) And (cOpc2(0).Enabled Or cOpc2(1).Enabled Or cOpc2(2).Enabled Or cOpc2(3).Enabled Or cOpc2(4).Enabled) Then
      If GrabarData() = 1 Then
         nflag = 0
            nl = IIf(modoventa.copiasGr > 0, modoventa.copiasGr, 0)
            If nl > 0 Then
               For J = 1 To nl
         ...
         If modoventa.emitefact = "1" Then
              ...
              End If
        End If
        If VGParamSistem.tesoreriaenlinea = 1 Then Call actualizatesoreria
             Listado (0)
         Else
            nflag = 0
         End If
...
Private Sub Ctr_Ayuda1_AlDevolverDato(ByVal ColecCampos As ADODB.Fields)
    ...
    If VGParametros.administraproyectos = 1 Then
        SQL = " clientecodigo='" & Ctr_Ayuda1.xclave & "' and proyectocierre=0 and tipoanaliticocodigo='" & VGParamSistem.tipoanaliticocodigo & "'"
...
If ESNULO(ColecCampos("stockenlinea"), False) Then
   If Chkentrega.Value = 0 Then
...
Function validar()
Dim montox As Double
Dim key As String
validar = False
montox = 0
If Ctr_Ayuoperacion.xclave = "" Then
   MsgBox ("Ingrese codigo de operacion ")
   Exit Function
End If
...
Listado (0)
cmdBotones(0).Enabled = Not VGParametros.cierremes
cmdBotones(1).Enabled = Not VGParametros.cierremes
cmdBotones(2).Enabled = Not VGParametros.cierremes
cmdBotones(4).Enabled = Not VGParametros.cierremes
...
cmdBotones(0).Enabled = IIf(VgModificar = True, False, True)
cmdBotones(1).Enabled = IIf(VgModificar = True, True, False)
...
Public Function Cargacombo()
   ...
   CargaGrilla
   MBox2(12) = rsdeta.RecordCount
   If MBox2(12) > modoventa.nroitem Then
      MsgBox "No se puede Ingresar mas Items...Verifique!!!", vbInformation, MsgTitle
      Exit Function
   End If
  
  
   Call dllgeneral.llenacombo(Combo1, "select monedacodigo,monedadescripcion from gr_moneda where monedacodigo<>'00'", VGCNx)
...
Public Function CargaGrilla()
   ...
   rsdeta.Open
    Call rsdetax.Fields.Append("empresacodigo", adVarChar, 2)
   Call rsdetax.Fields.Append("pedidonumero", adVarChar, 15)
   Call rsdetax.Fields.Append("pagocodigo", adChar, 2)
   Call rsdetax.Fields.Append("pagotipocodigo", adChar, 2)
   Call rsdetax.Fields.Append("pagonumdoc", adVarChar, 20)
   Call rsdetax.Fields.Append("monedacodigo", adVarChar, 2)
   Call rsdetax.Fields.Append("pagoimporte", adDouble, 2)
   Call rsdetax.Fields.Append("tipodecambio", adDouble)
...
Private Sub MBox2_LostFocus(Index As Integer)
      ...
      If Index Like "[45]" Then
       ...
       If Index = 5 And Len(Trim(MBox2(Index))) > 0 Then
        ...
        If rsdeta.RecordCount > 0 Then
            ...
            rsdeta.MoveFirst
            Do Until rsdeta.EOF
               If rsdeta.Fields(0) = MBox2(12) Then
                  posi = rsdeta.Fields(0)
                  Exit Do
               End If
               nregi = nregi + 1
        ...
        If VGParamSistem.tieneigv = "1" Then
           rsdeta.Fields(5) = MBox2(3)  '(MBox2(3) * MBox2(0) - (MBox2(4) / 100) * (MBox2(3) * MBox2(0))) / (1 + VGParamSistem.Igv/100) '(MBox2(3) * MBox2(0) - MBox2(4)) / (1 + VGParamSistem.Igv/100)
           rsdeta.Fields(11) = MBox2(3).Tag
        Else
           If modoventa.impuestos = "1" Then
              rsdeta.Fields(5) = (MBox2(3) / (1 + VGParamSistem.Igv) / 100)
              rsdeta.Fields(12) = MBox2(3).Tag
  ...
  '      rsdeta.Fields(7) = numero(MBox2(0) * MBox2(3) - ((MBox2(0) * MBox2(3)) * (MBox2(4) / 100))) 'numero(MBox2(0) * MBox2(3))   ' IIf(VGParamSistem.tieneigv = "1", (MBox2(3) / (1 + (VGParamSistem.igv / 100))), MBox2(3)))
        If modoventa.impuestos = 1 Then
           rsdeta.Fields(7) = numero(MBox2(0) * IIf(VGParamSistem.tieneigv = "1", MBox2(3) / (1 + VGParamSistem.Igv / 100), MBox2(3)))
         Else
           rsdeta.Fields(7) = 0
        End If
...
'       End If
       ...
       TImporte = rsdeta.Fields(4) * IIf(VGParamSistem.tieneigv, rsdeta.Fields(5) / (1 + VGParamSistem.Igv / 100), rsdeta.Fields(5))    '(rsdeta.Fields(7) + rsdeta.Fields(7))  'rsdeta.Fields(4) *
       If modoventa.impuestos = 1 Then
          TImporte = rsdeta.Fields(4) * IIf(VGParamSistem.tieneigv, rsdeta.Fields(5) / (1 + VGParamSistem.Igv / 100), rsdeta.Fields(5))
        Else
...
Public Function Carga_Pedido()
    ...
    If csql.RecordCount > 0 Then
       ...
       Ctr_AyuTransporte.xclave = Escadena(csql!transportecodigo): Ctr_AyuTransporte.Ejecutar
       Ctr_AyudaTc.xclave = Escadena(csql!tipocontactocodigo): Ctr_AyudaTc.Ejecutar
    ...
    Set csql = VGCNx.Execute("select detpeditem,A.productocodigo,b.adescri,a.unidadcodigo," & _
                          ...
                          " detpedporccomis,detpedcantpedidaref,detpedfactorconv,detpedpreciopact " & _
...
Public Function GrabarData() As Integer
        ...
        If asql.RecordCount > 0 Then
          If VGParamSistem.stockcomp = 1 Then
             ...
             Do Until asql.EOF
              ...
              Loop
           End If
           VGCNx.Execute "Delete From " & g_DetallePuntoVta & " where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'"
           VGCNx.Execute "Delete From " & g_PedidoPuntoVta & " where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'"
        End If
        asql.Close
        nsql = "Insert Into " & g_PedidoPuntoVta & "("
    ElseIf cOpc(1).Value Or cOpc3(1).Value Then
        Set asql = VGCNx.Execute("select * from vt_detallepedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'")
        If asql.RecordCount > 0 Then
           VGCNx.Execute "Delete From vt_detallepedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'"
           VGCNx.Execute "Delete From vt_pedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'"
        End If
        asql.Close
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
        If cOpc2(0).Value Then
          If cOpc(1).Value Then
             MBox(1) = g_pedserie & Right("0000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoped & "' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) 'MBox(1).MaxLength)
          End If
          'wCabe(34) = Date                       'fechafactura
          MBox(2) = g_facserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipofac & "' and puntovtadocserie='" & g_facserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) ' MBox(2).MaxLength)
          MBox(3) = "0": 'MBox(4) = "0"
        ...
        ElseIf cOpc2(1).Value Then
          ...
          MBox(3) = g_bolserie & Right("00000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipobol & "' and puntovtadocserie='" & g_bolserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) 'MBox(3).MaxLength)
          MBox(2) = "0"
        ...
        ElseIf cOpc2(3).Value Or cOpc2(4).Value Then
          If cOpc(1).Value Then
             MBox(1) = g_pedserie & Right("0000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoped & "' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) 'MBox(1).MaxLength)
          End If
             If cOpc2(3).Value Then
                MBox(3) = g_ticserieb & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where  empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoticketB & "' and puntovtadocserie='" & g_ticserieb & "' and puntovtacodigo='" & g_ptoventa & "' ", VGCNx), 10) ' MBox(1).MaxLength)
                If dllgeneral.VerificaDatoExistente(VGCNx, "select * from vt_pedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonrofact='" & MBox(3) & "' and pedidotipofac='" & g_tipoticketB & "'") = 1 Then
                   MsgBox "Ya existe Documento " & g_tipoticketB & "-" & MBox(3), vbInformation, MsgTitle
                   GrabarData = 0
                   Exit Function
                End If
             End If
            If cOpc2(4).Value Then
                MBox(3) = g_ticserief & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where  empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoticketf & "' and puntovtadocserie='" & g_ticserief & "' and puntovtacodigo='" & g_ptoventa & "' ", VGCNx), 10) ' MBox(1).MaxLength)
                If dllgeneral.VerificaDatoExistente(VGCNx, "select * from vt_pedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonrofact='" & MBox(3) & "' and pedidotipofac='" & g_tipoticketf & "'") = 1 Then
                   MsgBox "Ya existe Documento " & g_tipoticketf & "-" & MBox(3), vbInformation, MsgTitle
                   GrabarData = 0
                   Exit Function
                End If
          End If
    ...
    If cOpc(1).Value Or cOpc(0).Value Then
        ...
        VGCNx.BeginTrans
           If cOpc(0).Value Then
               MBox(1) = g_pedserie & Right("0000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoped & "' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) 'MBox(1).MaxLength)
           End If
           nsql = "Update vt_puntovtadocumento " & _
                " set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(1) + 1)), 10) & "'" & _
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
         If cOpc2(0).Value Then
            ...
            nsql = "Update vt_puntovtadocumento " _
                  & " set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(2) + 1)), 10) & "' " _
         ...
         ElseIf cOpc2(1).Value Then
            ...
            nsql = "Update vt_puntovtadocumento " _
                    & " set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(3) + 1)), 10) & "' " _
         ...
         ElseIf cOpc2(3).Value Or cOpc2(4).Value Then
             ...
             If cOpc2(3).Value Then
                 nsql = "Update vt_puntovtadocumento " & _
                    "set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(3) + 1)), 10) & "'" & _
                    " Where documentocodigo='" & g_tipoticketB & "' and puntovtacodigo='" & g_ptoventa & "' and puntovtadocserie='" & g_ticserieb & "'"
                 Else
                  nsql = "Update vt_puntovtadocumento " & _
                    "set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(3) + 1)), 10) & "'" & _
                    " Where documentocodigo='" & g_tipoticketf & "' and puntovtacodigo='" & g_ptoventa & "' and puntovtadocserie='" & g_ticserief & "'"
             End If
        ...
        If modoventa.emiteguia = 1 Then
            nsql = "Update vt_puntovtadocumento " & _
                       "set puntovtadoccorr='" & Right("0000000000" & Trim(CStr(MBox(4) + 1)), 10) & "'" & _
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
      ...
      ElseIf cOpc2(3).Value Then
         wCabe(3) = Trim(MBox(3))
         wCabe(4) = g_tipoticketB
      ElseIf cOpc2(4).Value Then
         wCabe(3) = Trim(MBox(3))
         wCabe(4) = g_tipoticketf
      End If
    Else
    ...
    With acmd
        ...
        .Parameters("@proyecto") = Ctr_AyuAnalitico.xclave
    End With
    acmd.Execute
    Set acmd = Nothing
    DoEvents
  If modoventa.ctrlinventario = "1" And (cOpc3(1).Value Or cOpc(1).Value) Then
     If Chkentrega.Value = 0 Then
        Set arbusca = Nothing
        Set arbusca = VGCNx.Execute(" select tanumsal from tabalm where taalma='" & wCabe(19) & "'")
        wCabe(5) = Format(arbusca!tanumsal, "00000000000")
        Set arbusca = VGCNx.Execute(" update tabalm set tanumsal=tanumsal+ 1 where taalma='" & wCabe(19) & "'")
        Set acmd.ActiveConnection = VGGeneral
        acmd.CommandType = adCmdStoredProc
  ...
  End If
    ...
    Do Until rsdeta.EOF
           ...
           If VGParamSistem.tieneigv = "1" Then
              'CALCULAMOS EL IGV
              Previo = (TSub * VGParamSistem.Igv / 100)
           Else
                If modoventa.impuestos = "1" Then
        ...
        With acmd
            ...
            .Parameters("@empresa") = VGParametros.empresacodigo
            .Parameters("@tipo") = "1"
            .Parameters("@item") = Format(rsdeta.Fields(0), "000")
            ...
            .Parameters("@dsctoxitem") = rsdeta.Fields(6)
            .Parameters("@importebruto") = TImporte
            .Parameters("@porcomision") = rsdeta.Fields(8)
            .Parameters("@mdsctoitem") = Tdscto
            .Parameters("@mdsctoxlinea") = 0
            .Parameters("@mdsctoxprom") = 0     '0
            .Parameters("@mimpor") = Previo ' rsdeta.Fields(7) - (rsdeta.Fields(7) / (1 + VGParamSistem.Igv / 100)) 'Previo
            .Parameters("@unidadref") = IIf(IsNull(rsdeta.Fields(9)) Or Len(Trim(rsdeta.Fields(9))) = 0, 0, CDbl(rsdeta.Fields(9)))
            ...
            If modoventa.ctrlinventario = "1" Then
               ...
               If cOpc2(0).Value Or cOpc2(1).Value Or cOpc2(2).Value Or cOpc2(3).Value Or cOpc2(4).Value Then     'PUEDE SER AKI
                    ...
                    ElseIf cOpc2(3) Then
                        ...
                        xfactu = Val(Right(LblTicSer.Caption, 10))
                        xtipofac = g_tipoticketB
                      Else
                        xserie = Left(LblTicSer.Caption, 4)
                        xfactu = Val(Right(LblTicSer.Caption, 10))
                        xtipofac = g_tipoticketf
 ...
 SQL = "UPDATE " & g_PedidoPuntoVta & " Set Pedidototinafecto=" & tinafecto
 SQL = SQL & " Where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonumero='" & MBox(1) & "'"
' VGCNx.Execute (SQL)
    
   '*Grabar en los cargos ***ctacte ***
    
    If (cOpc2(0).Value Or cOpc2(1).Value Or cOpc2(2).Value Or cOpc2(3).Value Or cOpc2(4).Value) And modoventa.ctacte = "1" Then
        lzona = "00"
        ...
        With acmd
            ...
            .Parameters("@tipodocu") = wCabe(4)
            .Parameters("@numero") = wCabe(3)
    ...
    End If
    If rsdetax.RecordCount > 0 And Not modoventa.canje Then
       rsdetax.MoveFirst
       Do Until rsdetax.EOF
          Set acmd.ActiveConnection = VGGeneral
          acmd.CommandType = adCmdStoredProc
          acmd.CommandTimeout = 0
          acmd.CommandText = "vt_pagosencaja_pro"
          acmd.Prepared = True
        With acmd
            .Parameters("@base") = VGCNx.DefaultDatabase
            .Parameters("@tipo") = 1
            .Parameters("@empresa") = VGParametros.empresacodigo
            .Parameters("@pedidonumero") = wCabe(2)
            .Parameters("@pagocodigo") = rsdetax!pagocodigo
            .Parameters("@pagotipocodigo") = rsdetax!pagotipocodigo
            .Parameters("@numdoc") = rsdetax!pagonumdoc
            .Parameters("@moneda") = rsdetax!monedacodigo
            .Parameters("@importe") = rsdetax!pagoimporte
            .Parameters("@tipocambio") = wCabe(10)
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
         ...
         ElseIf cOpc2(3).Value Then
              MsgBox "Se Grabo Satisfactoriamente el Documento." & Chr(13) & Chr(10) & "TICKET BOL => " & MBox(3), vbInformation, MsgTitle
         ElseIf cOpc2(4).Value Then
              MsgBox "Se Grabo Satisfactoriamente el Documento." & Chr(13) & Chr(10) & "TICKET FACT => " & wCabe(3), vbInformation, MsgTitle
         Else
    ...
    If Combo2.ListCount > 0 Then
       ...
       Else
          If VGParamSistem.stockcomp = 0 Then
            nsql = "select *,stskdis=isnull(case when afstock=0 then 999 else stskdis end,0) from dbo.maeart " & _
                    "left join [" & _
                    VGCNx.DefaultDatabase & "].dbo.stkart " & _
                    " ON acodigo=stcodigo " & _
                    " where acodigo='" & MBox2(1) & "' and isnull(stalma,'" & Ctr_Ayuda3.xclave & "')='" & Ctr_Ayuda3.xclave & "'"
           Else
...
ElseIf (cOpc3(1).Value Or cOpc(1).Value) And cOpc2(1).Value Then
    Call ImprimirBoleta
ElseIf (cOpc3(1).Value Or cOpc(1).Value) And (cOpc2(3).Value Or cOpc2(4).Value) Then
    NombreImpresora = "T"
    Call ImprimirTicket
End If
...
Call ImpresionRptProc(reporte, formulas, Param, , "Impresion de Ticket")
...
Public Sub CargarModo()
     ...
     If rs.RecordCount > 0 Then
        ...
        modoventa.copiasGr = IIf(IsNull(rs!modovtacopiasguiarem), 0, rs!modovtacopiasguiarem)
        ...
        modoventa.canje = ESNULO(rs!modovtacanje, 0)
       ...
       MBox(4).Enabled = IIf(modoventa.documento = g_tipoguia And modoventa.numeraauto <> "1", True, False)   'Modo de Modifica
        ...
        modoventa.documento = Escadena(IIf(IsNull(rs!documentocodigo), "", rs!documentocodigo))
         ...
         MBox2(11).Enabled = IIf(modoventa.usafactor = 1 Or (modoventa.usafactor = "1" And modoventa.unidadmedida = "R"), True, False)
     End If
     rs.Close
     Set rs = Nothing
...
If VgModificar = True Then cmdBotones_Click (1)
End Sub
...
VGCNx.BeginTrans
    ...
    With acmd
        ...
        .Parameters("@cajacodigo") = rs!banco
     ...
     Set acmd = Nothing
             ...
             With acmd
                 ...
                 .Parameters("@cliente") = RTrim(wCabe(16))
                 .Parameters("@usuario") = g_usuario
                 .Parameters("@fechaact") = Now
             End With
             acmd.Execute
...
Public Function ValidaNegativos()
  Dim rabusca As New ADODB.Recordset
  Dim nsql As String
  Dim nvalor As Double
  Dim mone As String
  ...
  ValidaNegativos = 0
    If rsdeta.RecordCount > 0 Then
       ...
       Do Until rsdeta.EOF
          If VGParamSistem.stockcomp = 0 Then
            nsql = "select *,stskdis=isnull(stskdis,0) from [" & VGCNx.DefaultDatabase & "].dbo.maeart " & _
                    "left join [" & _
                    VGCNx.DefaultDatabase & "].dbo.stkart " & _
                    " ON acodigo=stcodigo " & _
                    " where acodigo='" & rsdeta!codigo & "' and stalma='" & Ctr_Ayuda3.xclave & "'"
           Else
             nsql = "select *,(stskdis-stskcom) as stskdis from [" & VGCNx.DefaultDatabase & "].dbo.maeart " & _
                    "inner join [" & _
                    VGCNx.DefaultDatabase & "].dbo.stkart " & _
