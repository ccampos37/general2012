...
Begin VB.Form FrmPedidoGlosa1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPedidoGlosa1.frx":000C
      ...
      TabPicture(1)   =   "FrmPedidoGlosa1.frx":0028
      ...
      TabPicture(2)   =   "FrmPedidoGlosa1.frx":0044
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   1005
         Left            =   -69510
         Picture         =   "FrmPedidoGlosa1.frx":0060
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   585
         Width           =   1140
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   150
            Picture         =   "FrmPedidoGlosa1.frx":0970
            Top             =   210
            Width           =   480
         End
      ...
      Begin VB.Frame Fr1 
         ...
         Begin VB.Image Image2 
            Height          =   540
            Left            =   270
            Picture         =   "FrmPedidoGlosa1.frx":0DB2
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
         Begin VB.Image Image3 
            Height          =   540
            Left            =   2430
            Picture         =   "FrmPedidoGlosa1.frx":15CA
            Stretch         =   -1  'True
            Top             =   225
            Width           =   540
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame Fr5 
            ...
            Begin VB.Image Image5 
               Height          =   540
               Left            =   2295
               Picture         =   "FrmPedidoGlosa1.frx":1BF9
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
            Begin VB.Image Image4 
               Height          =   540
               Left            =   270
               Picture         =   "FrmPedidoGlosa1.frx":2029
               Stretch         =   -1  'True
               Top             =   180
               Width           =   540
            End
   ...
   End
End
Attribute VB_Name = "FrmPedidoGlosa1"
...
If VGParametros.multifacturas Then
   reporte = "vt_bolimpresa_" & VGCNx.DefaultDatabase & VGParametros.empresacodigo & VGParametros.puntovta & ".rpt"
Else
   reporte = "vt_bolimpresa_" & VGCNx.DefaultDatabase & VGParametros.empresacodigo & VGParametros.puntovta & ".rpt"
End If
        ...
        If rb.RecordCount > 0 Then
           ...
           Do While contador < numguias
              ...
              VGCNx.Execute "Update vt_puntovtadocumento " & _
                  " set puntovtadoccorr='" & Right("00000000" & Trim(CStr(Val(nguia) + 1)), 10) & "'" & _
...
'       End If
       ...
       FrmAyuda.TipoForma = 1
       FrmAyuda.BConexion = VGCNx
       SQL = " select stalma=isnull(stalma,'" & Ctr_Ayuda3.xclave & "'),acodigo,acodigo2,adescri,stskdis=case when isnull(afstock,1)=0 then 999 else isnull(stskdis,0) end,"
       SQL = SQL & " stskcom=isnull(stskcom,0) into ##XX_VENTAS from maeart "
       SQL = SQL & " left join ( select * from stkart where stalma='" & Ctr_Ayuda3.xclave & "') b "
       SQL = SQL & " on acodigo=stcodigo "
 ...
 '      End If
       ...
       Else
          If VGParamSistem.stockcomp = 1 Then
             ...
             End If
           Else
             FrmAyuda.BCampos = "acodigo as Codigo,acodigo2 as tipo,adescri as Descripcion,stskdis as Stock"
          End If
       End If
...
Private Sub cBoton_Click(Index As Integer)
  ...
  If Index = 0 Then
       ...
       MBox(1) = g_pedserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='" & g_tipoped & "' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "' and empresacodigo='" & VGParametros.empresacodigo & "'", VGCNx), 10)
...
Public Function CargaGrilla()
   ...
   Call rsdetax.Fields.Append("pedidonumero", adVarChar, 11)
...
Public Function GrabarData() As Integer
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
        If cOpc2(0).Value Then
          If cOpc(1).Value Then
             MBox(1) = g_pedserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='" & g_tipoped & "' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10) 'MBox(1).MaxLength)
          End If
    ...
    If cOpc(1).Value Or cOpc(0).Value Then
        ...
        nsql = "Update vt_puntovtadocumento " & _
                " set puntovtadoccorr='" & Right("00000000" & Trim(CStr(MBox(1) + 1)), 10) & "'" & _
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
         If cOpc2(0).Value Then
            ...
            nsql = "Update vt_puntovtadocumento " _
                  & " set puntovtadoccorr='" & Right("00000000" & Trim(CStr(MBox(2) + 1)), 10) & "' " _
         ...
         ElseIf cOpc2(1).Value Then
            ...
            nsql = "Update vt_puntovtadocumento " _
                    & " set puntovtadoccorr='" & Right("00000000" & Trim(CStr(MBox(3) + 1)), 10) & "' " _
        ...
        If modoventa.emiteguia = 1 Then
            nsql = "Update vt_puntovtadocumento " & _
                       "set puntovtadoccorr='" & Right("00000000" & Trim(CStr(MBox(4) + 1)), 10) & "'" & _
  ...
  If modoventa.ctrlinventario = "1" And (cOpc3(1).Value Or cOpc(1).Value) Then
     If Chkentrega.Value = 0 Then
        If modoventa.emiteguia = 1 Then
           guias_num = g_pedserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where empresacodigo='" & VGParametros.empresacodigo & "' and documentocodigo='GR' and puntovtadocserie='" & g_pedserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10)
           wCabe(5) = guias_num
              
           VGCNx.Execute "Update vt_puntovtadocumento " & _
                " set puntovtadoccorr='" & Right("00000000" & Trim(CStr(Val(guias_num) + 1)), 10) & "'" & _
