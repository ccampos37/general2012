...
Dim i As Integer
      ...
      "modovtacopiasboleta as 'C.Bol.', modovtacopiasguiarem as 'GuiaRem'," & _
      ...
      If rs2.RecordCount > 0 Then
        ReDim Arreglo_Doc(0 To 1, 0 To rs2.RecordCount - 1)
        Call fncLlenarArreglo_Combo(rs2, cmbDocumento, Arreglo_Doc, 1)
      End If
      Setear_Controles
...
Private Function fncLlenarArreglo_Combo(rs1 As Recordset, Cbo As ComboBox, Arreglo As Variant, dimensiones As Integer)
Dim i As Integer
Dim J As Integer
    ...
    Cbo.Clear
    Do Until rs1.EOF
        Cbo.AddItem (Trim(rs1(1)))
        For J = 0 To dimensiones
            Arreglo(J, i) = Trim(rs1(J))
        Next J
        rs1.MoveNext
        i = i + 1
    Loop
