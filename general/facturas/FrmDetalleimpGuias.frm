...
Begin VB.Form FrmDetalleImpGuias 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   11
         Left            =   90
         Picture         =   "FrmDetalleimpGuias.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   180
         Width           =   870
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   12
         Left            =   1140
         Picture         =   "FrmDetalleimpGuias.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   180
         Width           =   825
   ...
   End
End
Attribute VB_Name = "FrmDetalleImpGuias"
...
VGCNx.Execute "INSERT into gtempfile" & _
         " Select a.detpedcantpedida,a.productocodigo,b.adescri,(a.detpedimpbruto/a.detpedcantpedida),a.detpedimpbruto,a.detpeddsctoxitem,isnull(a.detpedcantpedidaref,0), case ltrim(rtrim(a.productocodigo)) when '000' then '' else a.unidadcodigo end,c.transportecodigo" & _
         " From " & ntabla & " A inner join " & _
         "[" & VGCNx.DefaultDatabase & "].dbo.maeart B" & _
         " ON A.productocodigo=b.acodigo inner join vt_pedido c on a.pedidonumero=c.pedidonumero COLLATE Modern_Spanish_CI_AI " & _
         " Where a.pedidonumero='" & CStr(Label2(2)) & "'"
...
'                   .formulas(2) = "fecha='" & CStr(Day(CDate(Label2(0)))) & "     " & adll.DesMes(Month(CDate(Label2(0)))) & "                       " & Right(CStr(Year(CDate(Label2(0)))), 4) & "'"
              ...
              '     .Formulas(6) = "ocompra='" & MBox(17) & "'"
                   ...
                   Else
                    .formulas(9) = "destino='" & TxtDes.Text & "'"
                   End If
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Case 11
    If adll.VerificaDatoExistente(VGCNx, "select * from vt_abono where documentoabono='" & adll.ComboDato(Label2(1)) & "' and abononumdoc='" & Mid(Label2(1), Len(g_tipofac) + 2, Len(Trim(Label2(1)))) & "'") = 1 Then
      MsgBox "No se puede Imprimir el documento esta anulado...verifique!!!", vbInformation, MsgTitle
      Exit Sub
    End If
    Frame3.Visible = True
