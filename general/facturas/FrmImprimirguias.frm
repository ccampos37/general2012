...
Begin VB.Form FrmImprimirguias 
   ...
   End
End
Attribute VB_Name = "FrmImprimirguias"
...
Private Sub Form_Load()
  ...
  Call CargarTipoVentas(Combo1, 6)
  nLongicampo(1) = 0
  Listado
End Sub
...
Public Function Listado()
  ...
  TDBGrid1.ClearFields
  TDBGrid1.Refresh
  Call adll.ListarEnTDBGRID(VGCNx, "vt_pedido", TDBGrid1, "CASE  pedidocondicionfactura WHEN '1' THEN '*' ELSE '' END,pedidofecha,pedidonumero,pedidotipofac,pedidonrofact,clienterazonsocial,pedidototneto", "pedidofecha", nLongicampo)
  ConfiguraGrid
End Function
...
Private Sub TDBGrid1_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  If KeyCode = 13 Then
     If TDBGrid1.ApproxCount > 0 And TDBGrid1.Columns(0).Text <> "*" Then
        FrmDetalleImpGuias.Btipo = g_tipoped
        FrmDetalleImpGuias.BNumero = TDBGrid1.Columns(2).Text
        FrmDetalleImpGuias.Show 1
        Listado
     End If
  End If
