...
Begin VB.Form FrmPedido 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(0)=   "Fr2(2)"
      Tab(2).Control(1)=   "Fr2(1)"
...
Private Sub Form_Load()
   ...
   LISTAR VGCNx, "pedido", TDBGrid2, "pedidofecha as Fecha, documentocodigo as Tipo,seriedocnumero+'-'+pedidonumero as Documento,clienterazonsocial as Cliente,pedidomoneda as Mnd,pedidototbruto as Total", "pedidofecha,documentocodigo", nLongicampo
