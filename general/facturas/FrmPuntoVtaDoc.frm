...
Begin VB.Form FrmPtoVtaDoc 
   Caption         =   "Mantenimiento de Puntos Venta - Documentos"
   ClientHeight    =   7395
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9465
   ...
   Begin VB.Frame frmbotones 
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   0
         Left            =   225
         Picture         =   "FrmPuntoVtaDoc.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   180
         Width           =   915
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   1
         Left            =   1320
         Picture         =   "FrmPuntoVtaDoc.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   180
         Width           =   915
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   2
         Left            =   2440
         Picture         =   "FrmPuntoVtaDoc.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   180
         Width           =   870
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   4
         Left            =   4590
         Picture         =   "FrmPuntoVtaDoc.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   180
         Width           =   915
      ...
      Begin VB.CommandButton cmdBotones 
         ...
         Index           =   3
         Left            =   3510
         Picture         =   "FrmPuntoVtaDoc.frx":1108
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   180
         Width           =   870
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPuntoVtaDoc.frx":154A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "TDBGridProducto"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Mantenimiento"
      TabPicture(1)   =   "FrmPuntoVtaDoc.frx":1566
   ...
   End
End
Attribute VB_Name = "FrmPtoVtaDoc"
...
Private Sub cAcepta_Click()
   ...
   ''''''''
     ...
     If s_codigodocumento = g_tipoped Then
        SQL = "SELECT * from vt_pedido where pedidonumero = " & txt(0) & txt(1) & ""
        Set rs = VGCNx.Execute(SQL)
        If rs.RecordCount > 0 Then
           MsgBox "Numero de Pedido existente ", vbCritical, "Error"
   ...
   If modoinsert = True Then
         ...
         If Validar_CodigosDuplicados("INSERT") = True Then
          ...
          SQL = "INSERT INTO vt_puntovtadocumento " & _
               "(empresacodigo,puntovtacodigo,documentocodigo," & _
               "puntovtadocserie,puntovtadoccorr," & _
               "puntovtaguia2,puntovtaguia1,usuariocodigo " & _
               ") VALUES ('" & Ctr_Ayuempresa.xclave & _
    ...
    ElseIf modoedit = True Then
            ...
            SQL = "UPDATE vt_puntovtadocumento SET " & _
               ...
               "puntovtaguia2='" & txt(2) & "'," & _
               "puntovtaguia1='" & txt(3) & "'," & _
               "usuariocodigo='" & g_usuario & "' " & _
               "WHERE empresacodigo='" & Ctr_Ayuempresa.xclave & "' and puntovtacodigo='" & i_codigoptovta & "' " & _
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Select Case Index
     ...
     Case 3   'imprimir
          Call imprimir("RepvtPtoVtaDoc.rpt")
     Case 4  ' salir
       Unload Me
  End Select
Exit Sub
...
Public Function Mostrar_Data()
  ...
  Dim i As Integer
      ...
      "a.puntovtadoccorr as 'Correlativo Doc'," & _
      "a.puntovtaguia2 as 'Guia Rem.2 ( Boletas )'," & _
      "a.puntovtaguia1 as 'Guia Rem.1',empresacodigo as empresa" & _
      " " & _
      ...
      " where empresacodigo='" & VGParametros.empresacodigo & "' and a.puntovtacodigo='" & VGParametros.puntovta & "'" & _
   ...
   Do Until TDBGridProducto.EOF
      If operacion = "INSERT" Then
         If Trim(ArregloPuntovta(0, cmbPuntoVta.ListIndex)) = _
            Trim(TDBGridProducto.Columns.Item(0)) Then
                 If Trim(ArregloDocumento(0, cmbDocumento.ListIndex)) = _
                    Trim(TDBGridProducto.Columns.Item(2)) Then
                        If Trim(txt(0)) = _
                           Trim(TDBGridProducto.Columns.Item(4)) Then
         ...
         If Trim(ArregloPuntovta(0, cmbPuntoVta.ListIndex)) = _
            Trim(TDBGridProducto.Columns.Item(0)) Then
              If Trim(ArregloDocumento(0, cmbDocumento.ListIndex)) = _
                 Trim(TDBGridProducto.Columns.Item(2)) Then
                    If Trim(txt(0)) = _
                       Trim(TDBGridProducto.Columns.Item(4)) _
