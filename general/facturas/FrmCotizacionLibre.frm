...
Begin VB.Form FrmCotizacionLibre 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "TxtCliente"
      Tab(0).Control(2)=   "DtFechaDesde"
      Tab(0).Control(3)=   "TxtNro"
      Tab(0).Control(4)=   "cmdBotones(4)"
      Tab(0).Control(5)=   "cmdBotones(2)"
      Tab(0).Control(6)=   "cmdBotones(1)"
      Tab(0).Control(7)=   "cmdBotones(0)"
      Tab(0).Control(8)=   "TDBGrid2"
      Tab(0).Control(9)=   "DtFechaHasta"
      Tab(0).Control(10)=   "Label9"
      Tab(0).Control(11)=   "Label8"
      Tab(0).Control(12)=   "Label7"
      Tab(0).Control(13)=   "LblReg"
