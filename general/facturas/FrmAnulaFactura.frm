...
Begin VB.Form FrmAnulaFactura 
   ...
   Begin VB.Frame Fr2 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmAnulaFactura.frx":0000
         Left            =   990
         List            =   "FrmAnulaFactura.frx":0002
   ...
   Begin VB.Frame Fr1 
      ...
      Begin VB.Label Label1 
         Caption         =   "Dar ENTER  en la Fila  para Anular"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmAnulaFactura"
