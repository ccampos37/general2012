  ...
  Select Case Index
     ...
     Case 1   'modificar
         ...
         If DGrid1.Row < 0 Then
            Exit Sub
         End If
         i_codigocliente = Trim(DGrid1.Columns(0).Text)
         txt(0) = Trim(DGrid1.Columns(0).Text)
         txt(1) = Trim(DGrid1.Columns(1).Text)
         txt(2) = Trim(DGrid1.Columns(2).Text)
         txt(3) = Trim(DGrid1.Columns(3).Text)
         'Activo
     ...
     Case 3   'imprimir
         Call Imprimir("RepvtLimiteCredito.rpt")
     Case 4  ' salir
       Unload Me
  End Select
Exit Sub
