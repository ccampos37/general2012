...
Begin VB.Form FrmPedido 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPedidoDETALLADO.frx":0000
      ...
      TabPicture(1)   =   "FrmPedidoDETALLADO.frx":001C
      ...
      TabPicture(2)   =   "FrmPedidoDETALLADO.frx":0038
      ...
      Begin VB.Frame frmbotones 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   4
            Left            =   3375
            Picture         =   "FrmPedidoDETALLADO.frx":0054
            Style           =   1  'Graphical
            TabIndex        =   152
            Top             =   180
            Width           =   870
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   2
            Left            =   2340
            Picture         =   "FrmPedidoDETALLADO.frx":0496
            Style           =   1  'Graphical
            TabIndex        =   151
            Top             =   180
            Width           =   825
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   1
            Left            =   1260
            Picture         =   "FrmPedidoDETALLADO.frx":08D8
            Style           =   1  'Graphical
            TabIndex        =   150
            Top             =   180
            Width           =   870
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   0
            Left            =   180
            Picture         =   "FrmPedidoDETALLADO.frx":0D1A
            Style           =   1  'Graphical
            TabIndex        =   149
            Top             =   180
            Width           =   870
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   150
            Picture         =   "FrmPedidoDETALLADO.frx":115C
            Top             =   210
            Width           =   480
         End
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "FrmPedidoDETALLADO.frx":159E
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "Fr1(0)"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Datos Detalle"
         TabPicture(1)   =   "FrmPedidoDETALLADO.frx":15BA
         Tab(1).ControlEnabled=   -1  'True
         ...
         TabPicture(2)   =   "FrmPedidoDETALLADO.frx":15D6
         Tab(2).ControlEnabled=   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   12
            Left            =   1050
            Picture         =   "FrmPedidoDETALLADO.frx":179D
            Style           =   1  'Graphical
            TabIndex        =   56
            Top             =   180
            Width           =   855
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   11
            Left            =   90
            Picture         =   "FrmPedidoDETALLADO.frx":1BDF
            Style           =   1  'Graphical
            TabIndex        =   55
            Top             =   180
            Width           =   870
...
Dim xsql As New ADODB.Recordset
  ...
  ElseIf Index = 3 Then                             ' Ayuda de Productos
       ...
       FrmAyudaPedidos.TipoForma = 1
       FrmAyudaPedidos.BConexion = VGCNx
       SQL = " select stalma,acodigo,adescri,stskdis,stskcom into ##XX_VENTAS from maeart left join stkart b on acodigo=stcodigo where acodigo not in ( select codkit from kits )"
       SQL = SQL & " Union All select stalma,codkit,adescri,stskdis=min(stskdis),stskcom=min(stskcom) "
       SQL = SQL & " from (select stalma,codkit,codart,stskdis=(stskdis)/canart,stskcom=(stskcom)/canart "
       SQL = SQL & " from kits a inner join stkart c on a.codart=stcodigo) z "
       SQL = SQL & " inner join maeart c on z.codkit=c.acodigo group by stalma,codkit,adescri"
       If Combo2.ListCount > 0 Then
          If VGParamSistem.kitvirtual = 1 Then
               If Not ExisteElem(0, VGCNx, "##xx_ventas") Then Set xsql = VGCNx.Execute(SQL)
    ...
    If cOpc(1).Value Or cOpc3(1).Value Then
        ...
        ElseIf cOpc2(2).Value Then
         ...
         ' wCabe(34) = Date                       'fechaguia
          MBox(4) = g_guiaserie & Right("000000000000" & TraeDataSerie("select puntovtadoccorr from vt_puntovtadocumento where documentocodigo='" & g_tipoguia & "' and puntovtadocserie='" & g_guiaserie & "' and puntovtacodigo='" & g_ptoventa & "'", VGCNx), 10)  ' MBox(4).MaxLength)
          MBox(2) = "0": MBox(3) = "0"
