     ...
     Dim rb2 As New ADODB.Recordset
      ...
      If rb.RecordCount > 0 Then
          ...
          Do Until rb.EOF
            ...
            Set rb2 = VGCNx.Execute("select * from cp_proveedor where clientecodigo='" & rb!clientecodigo & "'")
...
Private Sub cAyuda_Click(Index As Integer)
 ...
 If Index = 0 Then
    If adll.VerificaDatoExistente(VGCNx, "select * from cp_tipodocumento where tdocumentotipo='C' and tdocumentoingplan='1'") = 1 Then
        ...
        FrmAyuda.BCondi = "tdocumentotipo='C'"
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Select Case Index
    ...
    Case 2   'ELIMINAR DATOS
        If rsdetavmodi.RecordCount > 0 Then
            ...
            'Eliminamos abono del documento
             ...
             Set rb = VGCNx.Execute("Select * From cp_cargo where " & _
                        "documentocargo='" & TDBGrid1.Columns(2).Text & "' and " & _
                        "cargonumdoc='" & Trim$(TDBGrid1.Columns(3).Text & TDBGrid1.Columns(4).Text) & "' and " & _
             ...
             VGCNx.Execute "insert into sysseguridad  values ('" & Date & "','" & Time & "','" & VGusuario & "','" & _
                       " Registro Eliminado... Documento : " & TDBGrid1.Columns(2).Text & "-" & Trim$(TDBGrid1.Columns(3).Text & TDBGrid1.Columns(4).Text) & _
                       " Planilla  : " & Escadena(Ctr_Ayuda1.xclave) & "- " & xcuenta & _
                       " Proveedor   : " & TDBGrid1.Columns(0).Text & _
                       " Fecha     : " & MBox1.Text & _
                       " Moneda    : " & TDBGrid1.Columns(7).Text & _
                       " Importe   : " & Numero(TDBGrid1.Columns(8).Text) & "')"
            

            VGCNx.Execute "delete from cp_cargo where " & _
                        "documentocargo='" & TDBGrid1.Columns(2).Text & "' and " & _
                        "cargonumdoc='" & Trim$(TDBGrid1.Columns(3).Text & TDBGrid1.Columns(4).Text) & "' and " & _
                        "abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and " & _
                        "clientecodigo='" & TDBGrid1.Columns(0).Text & "' and  " & _
    ...
    Case 11
      ...
      If adll.VerificaDatoExistente(VGCNx, "select * from cp_cargo where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and cargoapefecpla='" & MBox1 & "' ") = 0 Then
   ...
   '      Frmseguridadvarios.Show 1
      ...
      End If
      If nAyuda = "1" Then
        Call cargar_cargos("select * from cp_cargo where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and cargoapefecpla ='" & MBox1 & "' ")
...
Public Sub cargar_grilla()
   ...
   Call rsdetavmodi.Fields.Append("Descripcion", adChar, 30)
...
Private Sub TDBGrid1_HeadClick(ByVal ColIndex As Integer)
   ...
   If TDBGrid1.ApproxCount >= 0 Then
     ...
     nsql = "select clientecodigo,documentocargo,cargonumdoc,cargoapefecemi,cargoapefecvct,monedacodigo,cargoapeimpape,bancocodigo " & _
            " from cp_cargo where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and cargoapefecpla='" & MBox1 & "' order by " & CStr(ColIndex + 1)
...
Private Sub Text1_KeyPress(Index As Integer, KeyAscii As Integer)
  ...
  If KeyAscii = 13 Then
     If Index = 6 Then
        ...
        rsdetavmodi.Fields(8) = Numero(IIf(IsNull(Text1(5)) Or Len(Trim$(Text1(5))) = 0, 0, Text1(5)))
     ...
     ElseIf Index = 1 Then
       Set rb = VGCNx.Execute("select * from cp_tipodocumento where tdocumentocodigo='" & Trim$(Escadena(Text1(Index))) & "' and tdocumentotipo='C' and tdocumentoingplan='1'")
       If rb.RecordCount = 0 Then
     ...
     ElseIf Index = 3 Then
       ...
       Set rb = VGCNx.Execute("select * from cp_cargo where documentocargo='" & Text1(1) & "' and cargonumdoc='" & Trim$(Text1(2) & Text1(3)) & "'")
       If rb.RecordCount > 0 Then
