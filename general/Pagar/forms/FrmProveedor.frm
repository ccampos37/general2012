...
Begin VB.Form FrmProveedor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmProveedor.frx":0000
      ...
      TabPicture(1)   =   "FrmProveedor.frx":001C
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "Fr1(0)"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Representante"
      TabPicture(2)   =   "FrmProveedor.frx":0038
      ...
      Begin VB.Frame Fr3 
         ...
         Begin VB.Frame Fr3 
            ...
            Begin MSMask.MaskEdBox tipo2 
               ...
               PromptChar      =   "_"
            End
            Begin MSMask.MaskEdBox ctacte1 
               Height          =   255
               Left            =   2280
               TabIndex        =   86
               Top             =   2880
               ...
               PromptChar      =   "_"
            End
            Begin MSMask.MaskEdBox ctacte2 
               Height          =   255
               Left            =   2280
               TabIndex        =   87
               Top             =   3600
...
Private Sub cAyuda_Click(Index As Integer)
    ...
    Else
        MsgBox "Ingrese Código del Proveedor", vbCritical, "AVISO"
    End If
End Sub
...
Public Function CargaData()
  ...
  If rsc.RecordCount > 0 Then
        ...
        Combo1.ListIndex = (BuscaCombo(Combo1, ESNULO(rsc!negociocodigo, "")))
        ...
        tipo1 = Escadena(rsc!tipocuenta01)
        tipo2 = Escadena(rsc!tipocuenta02)
        ctacte1 = Escadena(rsc!cuenta01)
        ctacte2 = Escadena(rsc!cuenta02)
 ...
 ' d_descuento = IIf(Len(trim$(MBox(21))) = 0, 0, CDbl(MBox(21)) / 100)
  ...
  If opc = 0 Then
     ...
     "clienterazonsocial,clientesiglas,clientedireccion,proveedorcontribuyente," & _
             ...
             "clientefax,clientemail,clientetipopersona,clientetipopais," & _
             "clientesuspendido,clienteaval," & _
             "clientefechaactivacion,clientefechabajaoanula," & _
             "clientediasmaxpagocont,clientepropietario,clienteprople," & _
             "clientepropruc,clientepropdirecc,clienteproptelefono," & _
             "tipocuenta01,tipocuenta02,cuenta01,cuenta02," & _
             "clientepropcodpostal,fechaact,usuariocodigo,clientedistrito,clientedescuento)" & _
     " VALUES(" & _
     "'" & MBox(0) & "','" & MBox(1) & "','" & BuscaPrefijo(Combo1.Text) & "'," & _
     "'" & MBox(2) & "','" & MBox(3) & "'," & _
     "'" & TextDir & "'," & Checkcontribuyente & "," & _
     "'" & Trim$(Ctr_CodPostal.xclave) & "','" & MBox(7) & "'," & _
             ...
             MBox(17) & "','" & MBox(18) & "'" & _
             ",'" & tipo1 & "','" & tipo2 & "','" & ctacte1 & "','" & ctacte2 & "'" & _
             ",'" & MBox(19) & "','" & Date & "','" & VGusuario & "','" & MBox(20) & "'," & d_descuento & ")"
  ...
  ElseIf opc = 1 Then
       ...
       nsql = "UPDATE cp_proveedor " & _
             ...
             "     clientedireccion='" & TextDir & "',clientecodpostal='" & Trim$(Ctr_CodPostal.xclave) & "'," & _
             ...
             "     tipocuenta01='" & tipo1 & "',tipocuenta02='" & tipo2 & "',cuenta01='" & ctacte1 & "',cuenta02='" & ctacte2 & "'," & _
  ...
  If Transaccion(nsql, VGCNx) = True Then
    VGCNx.CommitTrans
  Else
    VGCNx.RollbackTrans
  End If
...
Dim arrform(0) As Variant, arrparm(2) As Variant
