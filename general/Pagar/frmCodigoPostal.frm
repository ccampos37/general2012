...
Begin VB.Form frmCodigoPostal 
   ...
   End
End
Attribute VB_Name = "frmCodigoPostal"
...
Private Sub Form_Load()
   ...
   'Nombre Campos:
   a_Array(0, 0) = "codigopostal"
   a_Array(0, 1) = "descripcionpostal"
   a_Array(0, 2) = "observaciones"
   ...
   oTablasBasicas.NombreTabla = "cp_codigopostal"
