...
Private Sub cAyuda_Click(Index As Integer)
  ...
  nAyuda = "": nDetalle = ""
  If Index = 0 Then
     If adll.VerificaDatoExistente(VGCNx, "select * from cp_cargo where clientecodigo='" & Ctr_Ayuda2.xclave & "'") = 1 Then
        ...
        FrmAyuda.BCondi = "clientecodigo='" & Ctr_Ayuda2.xclave & "' and cargoapeflgcan<>'1' and b.tdocumentorenovarletras='1'"
  ...
  Select Case Index
       ...
       'Grabar datos a canjear
        ...
        If rsdetac1.RecordCount > 0 Then
            ...
            Do Until rsdetac1.EOF
                ...
                xparcial = ""
                Set rb = VGCNx.Execute("select * from cp_cargo where documentocargo='" & rsdetac1.Fields(2) & "' and cargonumdoc='" & rsdetac1.Fields(3) & rsdetac1.Fields(4) & "' AND clientecodigo='" & Ctr_Ayuda2.xclave & "'")
                If rb.RecordCount > 0 Then
                   xzona = rb!zonacodigo
                ...
                If rsdetac1.Fields("moneda") = g_TipoDolar Then
                   If xmone = g_TipoSol Then
                       VGCNx.Execute "Update  cp_cargo Set cargoapeimppag=isnull(cargoapeimppag,0)+" & CDbl(rsdetac1.Fields("importe") / xtcam) & "," & _
                                  ...
                                  " and clientecodigo='" & Ctr_Ayuda2.xclave & "'"
                   Else
        ...
        If rsdetac2.RecordCount > 0 Then
           ...
           Do Until rsdetac2.EOF
            ...
            If rsdetac2.Fields("moneda") = g_TipoDolar Then
                If xcargo = "C" Then
                   VGCNx.Execute "Update  cp_proveedor Set clientesaldodolares=isnull(clientesaldodolares,0)+" & CDbl(rsdetac2.Fields("importe")) & _
            ...
            ElseIf rsdetac2.Fields("moneda") = g_TipoSol Then
                If xcargo = "C" Then
                   VGCNx.Execute "Update  cp_proveedor Set clientesaldosoles=isnull(clientesaldosoles,0)+" & CDbl(rsdetac2.Fields("importe")) & _
                              " Where clientecodigo='" & Ctr_Ayuda2.xclave & "'"
                 Else
                   VGCNx.Execute "Update  cp_proveedor Set clientesaldosoles=isnull(clientesaldosoles,0)-" & CDbl(rsdetac2.Fields("importe")) & _
                              " Where clientecodigo='" & Ctr_Ayuda2.xclave & "'"
    ...
    Case 11
      ...
      If Len(Trim$(Ctr_Ayuda3.xclave)) = 0 Then
        ...
        Exit Sub
      End If
      If adll.VerificaDatoExistente(VGCNx, "select * from cp_tipoplanilla where tplanillarenovar='1' and tplanillacodigo='" & Escadena(Ctr_Ayuda1.xclave) & "' ") = 0 Then
...
Private Sub Text1_KeyPress(Index As Integer, KeyAscii As Integer)
  ...
  If KeyAscii = 13 Then
    ...
    ElseIf Index = 2 Then
       ...
       Set rb = VGCNx.Execute("select * from cp_cargo where documentocargo='" & Text1(0) & "' and cargonumdoc='" & Trim$(Text1(1) & Text1(2)) & "'")
       If rb.RecordCount = 0 Then
       ...
       Else
            ...
            If IsNull(rb!cargoapeimppag) Then
                If IsNull(rb!cargoapeimpape) Then
                    Text1(4) = Numero(0)
                Else
            ...
            Else
                If IsNull(rb!cargoapeimpape) Then
                    Text1(4) = Numero(-1 * rb!cargoapeimpape)
                Else
...
On Error Resume Next
  ...
  If KeyAscii = 13 Then
     ...
     If Index = 0 Then
       'Set rb = VGcnx.Execute("select * from cp_tipodocumento where tdocumentocodigo='" & Text2(Index) & "' and (tdocumentorenovarletras='1' or tdocumentodocrenovaletra='1')")
    ...
    ElseIf Index = 2 Then
       ...
       Set rb = VGCNx.Execute("select * from cp_cargo where documentocargo='" & Text2(0) & "' and cargonumdoc='" & Trim$(Text2(1) & Text2(2)) & "'")
       If rb.RecordCount > 0 Then
