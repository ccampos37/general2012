...
On Error GoTo Errores
 ...
 With oCrystalReport
        .Reset
        .ReportFileName = RutaRepProc & "RepcpSaldoxProveedor.rpt"
        ''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        .StoredProcParam(5) = IIf(chk(2).Value = 0, 0, 1)
        ...
        .WindowTitle = "Saldos por Proveedor"
        ''''''''''''''''''''''''''''''''''''''''''''''''''''
        .SubreportToChange = "RepcpSubSaldoxProveedor.rpt"
        .LogOnServer "pdssql.dll", _
         busca.LeerIni(App.Path & "\Camtex.ini", "Bgeneral", "dserver", ""), _
         busca.LeerIni(App.Path & "\Camtex.ini", "Bgeneral", "dbase", ""), _
         busca.LeerIni(App.Path & "\Camtex.ini", "Bgeneral", "duser", ""), _
