...
Begin VB.Form FrmPlanillaRenova 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPlanillaRenova.frx":0000
      ...
      TabPicture(1)   =   "FrmPlanillaRenova.frx":001C
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.Frame Frame6 
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   7
               Left            =   3255
               Picture         =   "FrmPlanillaRenova.frx":0038
               Style           =   1  'Graphical
               TabIndex        =   56
               Top             =   180
               Width           =   870
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   6
               Left            =   2280
               Picture         =   "FrmPlanillaRenova.frx":047A
               Style           =   1  'Graphical
               TabIndex        =   55
               Top             =   180
               Width           =   825
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   5
               Left            =   1260
               Picture         =   "FrmPlanillaRenova.frx":08BC
               Style           =   1  'Graphical
               TabIndex        =   54
               Top             =   180
               Width           =   870
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   4
               Left            =   180
               Picture         =   "FrmPlanillaRenova.frx":0CFE
               Style           =   1  'Graphical
               TabIndex        =   53
               Top             =   180
               Width           =   870
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame frmbotones 
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   0
               Left            =   180
               Picture         =   "FrmPlanillaRenova.frx":1140
               Style           =   1  'Graphical
               TabIndex        =   20
               Top             =   150
               Width           =   870
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   2
               Left            =   2250
               Picture         =   "FrmPlanillaRenova.frx":1582
               Style           =   1  'Graphical
               TabIndex        =   22
               Top             =   150
               Width           =   870
            ...
            Begin VB.CommandButton cmdBotones 
               ...
               Index           =   1
               Left            =   1230
               Picture         =   "FrmPlanillaRenova.frx":19C4
               Style           =   1  'Graphical
               TabIndex        =   21
               Top             =   150
               Width           =   825
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   12
            Left            =   1050
            Picture         =   "FrmPlanillaRenova.frx":1E06
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   180
            Width           =   855
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   11
            Left            =   90
            Picture         =   "FrmPlanillaRenova.frx":2248
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   180
            Width           =   870
   ...
   End
End
Attribute VB_Name = "FrmPlanillaRenova"
...
'FIXIT: Declare 'Cargar_grilla2' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
...
Private Sub cAyuda_Click(Index As Integer)
  ...
  If Index = 0 Then
     If adll.VerificaDatoExistente(VGCNx, "select * from vt_cargo where clientecodigo='" & Ctr_Ayuda2.xclave & "'") = 1 Then
        ...
        FrmAyudaCli.BCampos = "documentocargo as TD,cargonumdoc as Numero,monedacodigo as Mnd,Round(cargoapeimpape,2) as Total,Round((isnull(cargoapeimpape,0)-isnull(cargoapeimppag,0)),2) as Saldo"
        FrmAyudaCli.BOrden = "Clientecodigo,cargoapefecemi"
        FrmAyudaCli.BCondi = "clientecodigo='" & Ctr_Ayuda2.xclave & "' and (Round(cargoapeimpape,2)-Round(isnull(cargoapeimppag,0),2)>0) and b.tdocumentorenovarletras='1' and isnull(cargoapeflgreg,0)<>'1'"
  ...
  ElseIf Index = 1 Then
    If adll.VerificaDatoExistente(VGCNx, "select * from cc_tipodocumento where tdocumentodocrenovaletra='1'") = 1 Then
         ...
         FrmAyudaCli.BCondi = "tdocumentodocrenovaletra='1'"
         FrmAyudaCli.BFiltro = dfiltra
         FrmAyudaCli.Show 1
         Text2(0) = nAyuda
...
'FIXIT: Declare 'xabono' and 'xzona' and 'xmone' and 'xcuenta' and 'xcargo' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
  Dim xabono, xzona, xmone, xcuenta, xcargo, xcance As String
'FIXIT: Declare 'xparcial' con un tipo de datos de enlace en tiempo de compilación         FixIT90210ae-R1672-R1B8ZE
  ...
  Select Case Index
    ...
    Case 5  'Grabar Datos
       'Grabar datos a canjear
        ...
        If CDbl(Label6(0)) <> CDbl(Label6(1)) Then
            MsgBox "Los Planillas Totales no son Iguales....Verifique!!!", vbInformation, MsgTitle
            Exit Sub
        End If
        nflag = 1
        VGCNx.BeginTrans
        ...
        If rsdetac1.RecordCount > 0 Then
            ...
            Do Until rsdetac1.EOF
                ...
                xtcam = DatoTipoCambio(VGcnxCT, MBox1.Text)        'DatoTipoCambio(Date,vgcnx)
                ...
                If rsdetac1.Fields("moneda") = g_tipodolar Then
                   If xmone = g_tiposol Then
                       VGCNx.Execute "Update  vt_cargo Set cargoapeimppag=isnull(cargoapeimppag,0)+" & CDbl(rsdetac1.Fields("importe") / xtcam) & "," & _
                                  ...
                                  " Where documentocargo='" & rsdetac1.Fields(2) & "' and cargonumdoc='" & RTrim$(rsdetac1.Fields(3) & rsdetac1.Fields(4)) & "'"
                   Else
                ...
                VGCNx.Execute "Update  vt_cargo " & _
                            ...
                            " Where documentocargo='" & rsdetac1.Fields(2) & "' and cargonumdoc='" & RTrim$(rsdetac1.Fields(3) & rsdetac1.Fields(4)) & "'" & _
           ...
           Do Until rsdetac2.EOF
            ...
            Set rb = Nothing
              ...
              With acmd
                ...
                .Parameters("@planilla") = Right$("00000000" & RTrim$(CStr(xnumplan)), 6)
    ...
    Case 11
      ...
      If Len(RTrim$(Ctr_Ayuda2.xclave)) = 0 Then
        ...
        Exit Sub
      End If
      If Len(RTrim$(Ctr_Ayuda3.xclave)) = 0 Then
        MsgBox "Falta Ingresar Oficina/Vendedor...Verifique!!", vbInformation, MsgTitle
        Exit Sub
      End If
      If adll.VerificaDatoExistente(VGCNx, "select * from cc_tipoplanilla where tplanillarenovar='1' and tplanillacodigo='" & Escadena(Ctr_Ayuda1.xclave) & "' ") = 0 Then
            MsgBox "La planilla no es valida para realizar las renovaciones...Verifique!!!", vbInformation, MsgTitle
            Ctr_Ayuda1.SetFocus
            Exit Sub
      End If
...
Private Sub Form_Load()
  ...
  Ctr_Ayuda1.Filtro = "tplanillarenovar='1'"
...
Private Sub MBox2_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
 If KeyCode = 13 Then
    If Len(RTrim$(MBox2(Index).ClipText)) < 8 Then
...
'FIXIT: Declare 'xpago' and 'xcam' and 'J' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
  ...
  If KeyAscii = 13 Then
     ...
     If Index = 0 Then
       ...
       Set rb = Nothing
    ElseIf Index = 1 Then
       Text1(Index) = Right$("000000000000" & RTrim$(Text1(Index)), Text1(Index).MaxLength)
    ElseIf Index = 2 Then
       Text1(Index) = Right$("000000000000" & RTrim$(Text1(Index)), Text1(Index).MaxLength)
       
       Set rb = VGCNx.Execute("select * from vt_cargo where clientecodigo='" & Ctr_Ayuda2.xclave & "' and documentocargo='" & Text1(0) & "' and cargonumdoc='" & RTrim$(Text1(1) & Text1(2)) & "'")
       If rb.RecordCount = 0 Then
           MsgBox "El documento no existe....Verifique!!!", vbInformation, MsgTitle
           rb.Close
           Set rb = Nothing
           Label3(0) = "": Label3(1) = "": Label3(2) = "": Label3(3) = ""
           Exit Sub
       Else
            Label3(2) = IIf(IsNull(rb!cargoapefecemi), "", rb!cargoapefecemi)
            Label3(3) = IIf(IsNull(rb!cargoapefecvct), "", rb!cargoapefecvct)
            Text1(3) = Escadena(rb!monedacodigo)
            If IsNull(rb!cargoapeimppag) Then
                Text1(4) = numero(rb!cargoapeimpape)
            Else
               Text1(4) = numero(rb!cargoapeimpape - rb!cargoapeimppag)
            End If
            Set rb2 = VGCNx.Execute("select * from vt_cliente where clientecodigo='" & RTrim$(Escadena(rb!clientecodigo)) & "'")
    ...
    ElseIf Index = 4 Then
        ...
        Set rb = VGCNx.Execute("select * from vt_cargo where clientecodigo='" & Ctr_Ayuda2.xclave & "' and  documentocargo='" & Text1(0) & "' and cargonumdoc='" & RTrim$(Text1(1) & Text1(2)) & "'")
        If rb.RecordCount > 0 Then
            xpago = rb!cargoapeimpape - IIf(IsNull(rb!cargoapeimppag), 0, rb!cargoapeimppag)
     ...
     If Index = 0 Then
       ...
       Else
          If Not IsNull(rb.Fields("tdocumentonumeauto")) And rb.Fields("tdocumentonumeauto") = "1" Then
             Text2(1) = IIf(rb.Fields("tdocumentonumeauto") = "0", "", Right$("0000000000" & g_pedserie, 4))
             Text2(2) = IIf(rb.Fields("tdocumentonumeauto") = "0", "", Right$("0000000000" & RTrim$(rb.Fields("tdocumentonumerador")), 10))
             Text2(2).SetFocus
          Else
             Text2(1).SetFocus
             Exit Sub
       ...
       Set rb = Nothing
    ElseIf Index = 1 Then
       Text2(Index) = Right$("000000000" & RTrim$(Text2(Index)), Text2(Index).MaxLength)
    ElseIf Index = 2 Then
       Text2(Index) = Right$("000000000" & RTrim$(Text2(Index)), Text2(Index).MaxLength)
       
       Set rb = VGCNx.Execute("select * from vt_cargo where documentocargo='" & Text2(0) & "' and cargonumdoc='" & RTrim$(Text2(1) & Text2(2)) & "'")
       If rb.RecordCount > 0 Then
       ...
       Set rb = Nothing
     ElseIf Index = 3 Then
       Set rb = VGCNx.Execute("select * from gr_moneda where monedacodigo='" & RTrim$(Escadena(Text2(Index))) & "'")
       If rb.RecordCount = 0 Then
           MsgBox "La moneda no existe....Verifique!!!", vbInformation, MsgTitle
           rb.Close
           Set rb = Nothing
       ...
       rb.Close
       Set rb = Nothing
       Text2(4) = DatoTipoCambio(VGcnxCT, MBox1.Text)   'DatoTipoCambio(Date,vgcnx)
       
    ElseIf Index = 4 Or Index = 5 Then
        Text2(Index) = Format(RTrim$(Text2(Index)), "##,###,##0.00")
    ElseIf Index = 6 Then
       Tipodocu.numeauto = "0"
       Tipodocu.numerador = ""
