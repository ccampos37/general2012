   ...
   Select Case Index
    Case 11
        ...
        If GrabarData() = 1 Then
          cn.CommitTrans
          If MsgBox("Desea Imprimir la Nota de Credito  ", vbYesNo) = vbYes Then
              Call ImprimirNota
          End If
          g_TipoMovi = 0
...
Dim cuenta As Integer, j As Integer
    ...
    If rb2.RecordCount > 0 Then
        ...
        cn.Execute "INSERT into tempfile" & _
                 ...
                 " Where pedidonumero='" & rb2.Fields("pedidonumero") & "' and b.almacencodigo='" & Ctr_Ayuda3.xclave & "'"
         
         Set rb = cn.Execute("select * from tempfile")
         If rb.RecordCount > 0 Then
          Set rb3 = cn.Execute("select * from vt_modoventa where modovtacodigo='02'")
        ...
        Set rb = Nothing
         With oCrystalReport
               .Formulas(0) = "nro='" & rb2!pedidonrofact & "'"
                ...
                If rb3.RecordCount > 0 Then
                  .Formulas(8) = "cpago='" & Escadena(rb2!formapagocodigo) & "-" & Escadena(Trim(rb3!formapagodescripcion)) & "'"
                End If
                rb3.Close
                Set rb3 = Nothing
               .Formulas(9) = "opedido='" & rb2!pedidonumero & "'"
               .Formulas(10) = "ocompra=''"
               .Formulas(11) = "guia=''"
               .Formulas(12) = "fechaven='" & CStr(rb2!pedidofechafact) & "'"
               .Formulas(13) = "vendedor='" & Escadena(rb2!vendedorcodigo) & "'"
               .Formulas(14) = "bruto='" & Numero(MBox2(7)) & "'"
               .Formulas(15) = "dscto='" & MBox2(8) & "'"
               .Formulas(16) = "igv='" & MBox2(9) & "'"
               .Formulas(17) = "distrito='" & Escadena(rb2!clientedireccion) & "'"
               .Formulas(1) = "cliente='" & Escadena(rb2!clientecodigo) & "-" & Escadena(rb2.Fields("clienterazonsocial")) & "'"
               .Formulas(2) = "fecha='" & CStr(rb2!pedidofechafact) & "'"
               .Formulas(3) = "direccion='" & Escadena(rb2!clientedireccion) & "'"
               .Formulas(4) = "dni=''"
