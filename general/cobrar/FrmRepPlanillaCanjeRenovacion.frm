...
Dim mon As String
   ...
   NombreRep = "RepccPlanCanjeRenovacion.rpt"
   NombreSubRep = "RepccSubPlanCanjeRenovacion.rpt"
   CadOrden = ""
   Call ImpresionRpt_SubRpt_Proc(NombreRep, arrform, arrparm, NombreSubRep, CadOrden, "Planilla de " & cTitulo)
End Sub
