   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   12
            Left            =   1050
            Picture         =   "FrmPlanillaCobranzaModi.frx":047A
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   180
            Width           =   855
...
'FIXIT: Declare 'xabono' and 'xzona' and 'xmone' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
  ...
  Select Case Index
    ...
    Case 2   'ELIMINAR DATOS
        If rsdetacmodi.RecordCount > 0 Then
            ...
            Set rb = VGCNx.Execute("select * from cc_tipodocumento where tdocumentocodigo='" & TDBGrid1.Columns(5).Text & "'")
            ...
            Set rb = VGCNx.Execute("select * from vt_cargo where documentocargo='" & TDBGrid1.Columns(1).Text & "' and cargonumdoc='" & TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text & "' and clientecodigo='" & TDBGrid1.Columns(0).Text & "'")
            If rb.RecordCount > 0 Then
               xzona = rb!zonacodigo
               ...
               End If
            Else
               xzona = "00": xmone = g_TipoSol: xnumpag = 1
            End If
            rb.Close
            Set rb = Nothing
            ...
            If TDBGrid1.Columns(8).Text = g_TipoDolar Then
               If xmone = g_TipoSol Then
                   VGCNx.Execute "Update  vt_cargo Set cargoapeimppag=isnull(cargoapeimppag,0)-" & CDbl(TDBGrid1.Columns(10).Text * xtcam) & _
                              " Where documentocargo='" & TDBGrid1.Columns(1).Text & "' and cargonumdoc='" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & "' and clientecodigo='" & TDBGrid1.Columns(0).Text & "'"
               Else
                   VGCNx.Execute "Update  vt_cargo Set cargoapeimppag=isnull(cargoapeimppag,0)-" & CDbl(TDBGrid1.Columns(10).Text) & _
                              " Where documentocargo='" & TDBGrid1.Columns(1).Text & "' and cargonumdoc='" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & "' and clientecodigo='" & TDBGrid1.Columns(0).Text & "'"
               End If
            ...
            VGCNx.Execute "Update  vt_cargo " & _
                        ...
                        " Where documentocargo='" & TDBGrid1.Columns(1).Text & "' and cargonumdoc='" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & "' and clientecodigo='" & TDBGrid1.Columns(0).Text & "'" & _
                        "  and cargoapeimpape - isnull(cargoapeimppag,0)=0"
                        
            
            '**** Actualizamos Saldos del cliente
            If TDBGrid1.Columns(8).Text = g_TipoDolar Then
                  VGCNx.Execute "Update  vt_cliente Set clientesaldodolares=isnull(clientesaldodolares,0)+" & CDbl(TDBGrid1.Columns(10).Text) & _
                              " Where clientecodigo='" & TDBGrid1.Columns(0).Text & "'"
            ElseIf TDBGrid1.Columns(8).Text = g_TipoSol Then
                  VGCNx.Execute "Update  vt_cliente Set clientesaldosoles=isnull(clientesaldosoles,0)+" & CDbl(TDBGrid1.Columns(10).Text) & _
                              " Where clientecodigo='" & TDBGrid1.Columns(0).Text & "'"
            End If
            
            'Eliminamos abono del documento
            
             Set rb = VGCNx.Execute("Select * from vt_abono where " & _
                        "documentoabono='" & TDBGrid1.Columns(1).Text & "' and " & _
                        "abononumdoc='" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & "' and " & _
                        ...
                        "abonocanndqc='" & RTrim$(TDBGrid1.Columns(6).Text & TDBGrid1.Columns(7).Text) & "'")
             ...
             VGCNx.Execute "insert into sysseguridad  values ('" & Date & "','" & Time & "','" & g_usuario & "','" & _
                       " Registro Eliminado... Documento : " & TDBGrid1.Columns(1).Text & "-" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & _
                       " Planilla  : " & Escadena(Ctr_Ayuda1.xclave) & "- " & xcuenta & _
                       " Cliente   : " & TDBGrid1.Columns(0).Text & _
                       " Fecha     : " & MBox1.Text & _
                       " D.Cancela : " & TDBGrid1.Columns(5).Text & "-" & RTrim$(TDBGrid1.Columns(6).Text & TDBGrid1.Columns(7).Text) & _
                       " Moneda    : " & TDBGrid1.Columns(8).Text & _
                       " Importe   : " & Numero(TDBGrid1.Columns(10).Text) & "')"
            

            VGCNx.Execute "delete from vt_abono where " & _
                       "documentoabono='" & TDBGrid1.Columns(1).Text & "' and " & _
                       "abononumdoc='" & RTrim$(TDBGrid1.Columns(2).Text & TDBGrid1.Columns(3).Text) & "' and " & _
                       "abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and " & _
                       "abonocancli='" & TDBGrid1.Columns(0).Text & "' and  " & _
    ...
    Case 11
      ...
      If adll.VerificaDatoExistente(VGCNx, "select * from vt_abono where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and abonocanfecpla='" & MBox1 & "' ") = 0 Then
         MsgBox "No existe planilla de esa fecha y/o vendedor en el Tipo de Planilla...Verifique!!!", vbInformation, MsgTitle
         Exit Sub
      End If
      ...
      End If
      If nAyuda = "1" Then
        Call cargar_abonos("select * from vt_abono where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and abonocanfecpla='" & MBox1 & "' ")
...
'FIXIT: Declare 'cargar_abonos' and 'nsql' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
     ...
     Dim rb As New ADODB.Recordset
      ...
      If rb.RecordCount > 0 Then
          ...
          Do Until rb.EOF
            ...
            rsdetacmodi.Fields(8) = rb!abonocanmoncan
            rsdetacmodi.Fields(9) = rb!abonocanbco
            rsdetacmodi.Fields(10) = Numero(rb!abonocanimpcan)
            rsdetacmodi.Fields(11) = Format(rb!abonocantipcam, "#0.0000")
            rsdetacmodi.Update
            rb.MoveNext
          Loop
      End If
...
Private Sub TDBGrid1_HeadClick(ByVal ColIndex As Integer)
   ...
   If TDBGrid1.ApproxCount >= 0 Then
     ...
     nsql = "select abonocancli,documentoabono,abononumdoc,abononumdoc,abonocanforcan,abonocantdqc,abonocanndqc,abonocanndqc,abonocanmoneda,abonocanbco,abonocanimpcan,abonocantipcam " & _
            " from vt_abono where abonotipoplanilla='" & Escadena(Ctr_Ayuda1.xclave) & "' and vendedorcodigo='" & Ctr_Ayuda2.xclave & "' and abonocanfecpla='" & MBox1 & "' order by " & CStr(ColIndex + 1)
...
'FIXIT: Declare 'xpago' con un tipo de datos de enlace en tiempo de compilación            FixIT90210ae-R1672-R1B8ZE
 ...
 If rsdetacmodi.RecordCount > 0 Then
    ...
    Set rb = VGCNx.Execute("select * from vt_cliente where clientecodigo='" & RTrim$(Escadena(Text1(0))) & "'")
    If rb.RecordCount > 0 Then
       Label3(1) = Escadena(rb!clientecodigo) & "-" & Escadena(rb!clienterazonsocial)
    End If
    rb.Close
      
    Set rb = VGCNx.Execute("select * from cc_tipodocumento where tdocumentocodigo='" & Text1(1) & "' and tdocumentotipo='C'")
    If rb.RecordCount > 0 Then
