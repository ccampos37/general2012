...
Begin VB.Form FrmAnulaNota 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "Lblempresa"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "Ctr_Ayuempresa"
   ...
   End
End
Attribute VB_Name = "FrmAnulaNota"
...
Public Function GrabarData() As Integer
    ...
    If adll.VerificaDatoExistente(VGCNx, "select * from vt_abono where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and documentoabono='" & adll.ComboDato(Combo2) & "' and  abononumdoc='" & RTrim$(MBox(1) & MBox(2)) & "'") = 0 Then
         VGCNx.Execute " Update vt_pedido " & _
                     " Set pedidofechaanu='" & Date & "'," & _
                     "     pedidoestado=1 , estadoreg=1 , pedidocondicionfactura='1' " & _
                     " where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and pedidotipofac='" & adll.ComboDato(Combo2) & "' and pedidonrofact='" & RTrim$(MBox(1) & MBox(2)) & "'"
                     
         VGCNx.Execute " Update vt_cargo " & _
                    " Set cargoapeflgreg='1' " & _
                    " where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and documentocargo='" & adll.ComboDato(Combo2) & "' and cargonumdoc='" & RTrim$(MBox(1) & MBox(2)) & "'"
...
Private Sub cAyuda2_Click()
 ...
 If adll.VerificaDatoExistente(VGCNx, "select * from vt_cargo where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and documentocargo='" & adll.ComboDato(Combo2) & "'") = 1 Then
       ...
       FrmAyudaCli.BCondi = "empresacodigo='" & Ctr_Ayuempresa.xclave & "' and  documentocargo='" & adll.ComboDato(Combo2) & "' and clientecodigo='" & Ctr_Ayuda1.xclave & "' "
...
'FIXIT: Declare 'J' con un tipo de datos de enlace en tiempo de compilación                FixIT90210ae-R1672-R1B8ZE
   ...
   Select Case Index
    Case 11
       If adll.VerificaDatoExistente(VGCNx, "select * from vt_cargo where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and documentocargo='" & adll.ComboDato(Combo2.Text) & "' and cargonumdoc='" & RTrim$(MBox(1) & MBox(2)) & "' and clientecodigo='" & Ctr_Ayuda1.xclave & "'") = 0 Then
            MsgBox "El Documento fue eliminado...!!!", vbInformation, "AVISO"
            Exit Sub
        End If
    
       If adll.VerificaDatoExistente(VGCNx, "select * from vt_cargo where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and documentocargo='" & adll.ComboDato(Combo2.Text) & "' and cargonumdoc='" & RTrim$(MBox(1) & MBox(2)) & "' and clientecodigo='" & Ctr_Ayuda1.xclave & "' and cargoapeflgreg='1'") = 1 Then
            MsgBox "El Documento esta anulado...!!!", vbInformation, "AVISO"
            Exit Sub
        End If
        If MsgBox("Desea Anular el documento ", vbYesNo + vbDefaultButton2, "AVISO") = vbNo Then
            Exit Sub
        End If
...
Private Sub Ctr_Ayuempresa_AlDevolverDato(ByVal ColecCampos As ADODB.Fields)
  SQL = "select distinct a.* from cc_tipodocumento a inner join cc_parametro b on a.tdocumentocodigo=b.tdocumentonotaabono or a.tdocumentocodigo=b.tdocumentonotacargo or a.tdocumentocodigo=b.tdocumentonotacarbo or a.tdocumentocodigo=b.tdocumentonotaabobo"
     Call adll.llenacombo(Combo2, SQL, VGCNx)
End Sub
     ...
     If Index Like "[1278]" Then
        ...
        If Index = 2 Then
            ...
            If rb.RecordCount > 0 Then
                ...
                Ctr_Ayuda2.Ejecutar
                SQL = "select * from vt_pedido where empresacodigo='" & Ctr_Ayuempresa.xclave & "' and pedidotipofac='" & rb!documentocargo & "'"
                SQL = SQL & " and pedidonrofact='" & rb!cargonumdoc & "' and clientecodigo='" & rb!clientecodigo & "'"
                Set rb2 = VGCNx.Execute(SQL)
                If rb2.RecordCount > 0 Then
                    ...
                    Text1(1) = Format(rb2!pedidototaldsctoxitem, "##0.00")
                ...
                Text2 = Escadena(RTrim$(ESNULO(rb!cargoaperefere, "")))
