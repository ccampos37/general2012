...
Dim xfecha As Date
'FIXIT: Declare 'nlongi' con un tipo de datos de enlace en tiempo de compilación           FixIT90210ae-R1672-R1B8ZE
Dim nlongi(1)
...
Private Sub Form_Load()
  ...
  DoEvents
  Call Carga_Grilla
  Set rsbusca = VGCNx.Execute("select * from vt_Cargo where cargoapefecemi='" & xfecha & "' order by documentocargo")
  If rsbusca.RecordCount > 0 Then
    ...
    Do Until rsbusca.EOF
        ...
        rsdetab.Fields("Serie") = Left$(rsbusca.Fields("cargonumdoc"), 3)
        rsdetab.Fields("Numero") = Right$(rsbusca.Fields("cargonumdoc"), 8)
...
'FIXIT: Declare 'Carga_Grilla' con un tipo de datos de enlace en tiempo de compilación     FixIT90210ae-R1672-R1B8ZE
