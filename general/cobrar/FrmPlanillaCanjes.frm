...
Private Sub cAyuda_Click(Index As Integer)
  ...
  If Index = 0 Then
     If adll.VerificaDatoExistente(VGCNx, "select * from vt_cargo where clientecodigo='" & Ctr_Ayuda2.xclave & "'") = 1 Then
        ...
        FrmAyudaCli.BCampos = "documentocargo as TD,cargonumdoc as Numero,monedacodigo as Mnd,cargoapeimpape as Total,(isnull(cargoapeimpape,0)-isnull(cargoapeimppag,0)) as Saldo"
        ...
        FrmAyudaCli.Show 1
        Text1(0) = nAyuda
        Text1(1) = Left$(nDetalle, 4): Text1(2) = Right$(nDetalle, 10)
  ...
  ElseIf Index = 1 Then
    If adll.VerificaDatoExistente(VGCNx, "select * from cc_tipodocumento where tdocumentodocrenovaletra='1'") = 1 Then
         ...
         FrmAyudaCli.Show 1
         Text2(0) = nAyuda
'         Text2(1) = left$(nDetalle, 4): Text2(2) = right$(nDetalle, 10)
  ...
  Select Case Index
           ...
           Do Until rsdetac2.EOF
            ...
            Set rb = Nothing
              ...
              With acmd
                ...
                .Parameters("@cargonumbco") = RTrim$(rsdetac2.Fields(9))
                .Parameters("@empresa") = Ctr_Ayuempresa.xclave
              End With
              acmd.Execute
              Set acmd = Nothing
    ...
    Case 11
      ...
      If Len(RTrim$(Ctr_Ayuda2.xclave)) = 0 Then
        MsgBox "Falta Ingresar Punto de venta...Verifique!!", vbInformation, MsgTitle
        Exit Sub
      End If
      If Len(RTrim$(Ctr_Ayuda3.xclave)) = 0 Then
        ...
        Exit Sub
      End If
      If Len(RTrim$(Ctr_Ayuempresa.xclave)) = 0 Then
