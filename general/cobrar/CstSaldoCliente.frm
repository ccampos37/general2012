...
Begin VB.Form CstSaldoCliente 
   ...
   Caption         =   "Consulta de Saldo de Cliente"
   ClientHeight    =   7005
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7620
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Dim J As Integer
'FIXIT: Declare 'wsumasol' con un tipo de datos de enlace en tiempo de compilación         FixIT90210ae-R1672-R1B8ZE
  ...
  Select Case Index
    Case 11 'consultar datos
      ...
      Set rb = VGCNx.Execute("select documentocargo,tdocumentodescripcion,tdocumentotipo," & _
                        ...
                        " on vt_cargo.documentocargo=cc_tipodocumento.tdocumentocodigo " & _
                        " where clientecodigo='" & Ctr_Ayuda1.xclave & "' and (cargoapeflgreg<>'1' or cargoapeflgreg is null) and (cargoapeimpape-isnull(cargoapeimppag,0)>0)" & _
      ...
      If rb.RecordCount > 0 Then
         ...
         Do Until rb.EOF
            ...
            MGrid1.Col = 0: MGrid1.CellAlignment = 0: MGrid1.TextMatrix(MGrid1.RowSel, 0) = RTrim$(rb.Fields(0))
            MGrid1.Col = 1: MGrid1.CellAlignment = 0: MGrid1.TextMatrix(MGrid1.RowSel, 1) = RTrim$(rb.Fields(1))
