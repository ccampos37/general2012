...
Begin VB.Form frmBanco 
   ...
   Begin UMantenimiento.TablasBasicas TablasBasicas 
      Height          =   8895
      Left            =   0
      TabIndex        =   1
      Top             =   0
...
Private Sub Form_Load()
   ...
   TablasBasicas.conexion = VGCNx
   TablasBasicas.NombreTabla = "gr_banco"
   TablasBasicas.Arreglo = a_Array
   TablasBasicas.Setear_Controles
   TablasBasicas.Obtener_Campos
   TablasBasicas.cargar_datos
      ''''''''Descripciones Duplicadas
   TablasBasicas.DescripcionDuplicada = False
   TablasBasicas.CampoDescripcion = 1

End Sub

'FIXIT: Declare 'indice' con un tipo de datos de enlace en tiempo de compilación           FixIT90210ae-R1672-R1B8ZE
Private Sub TablasBasicas_Click(indice As Variant)
   If indice = 3 Then
...
Private Sub TablasBasicas_txtCodigoLostFocus(indice2 As Variant)  'Formatea con ceros el campo codigo
    If indice2 = 0 Then
        Call TablasBasicas.Formatear_Codigo(indice2)
    End If
End Sub
