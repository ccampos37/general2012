...
Begin VB.Form frmMantAsiento 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMantAsiento.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "frmbotones"
      Tab(0).Control(1)=   "TDBGridAsientos"
      Tab(0).Control(2)=   "Label1"
      Tab(0).Control(3)=   "lblNumReg"
      Tab(0).ControlCount=   4
      TabCaption(1)   =   "Mantenimiento"
      TabPicture(1)   =   "frmMantAsiento.frx":001C
      ...
      TabPicture(2)   =   "frmMantAsiento.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "txt(8)"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "txt(9)"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "txt(10)"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "txt(4)"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "txt(5)"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "txt(6)"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "txt(7)"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "txt(11)"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "txt(12)"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "txt(13)"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "txt(3)"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "txt(14)"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "lbl(5)"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "lbl(6)"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "lbl(7)"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "lbl(8)"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "lbl(9)"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "lbl(10)"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "lbl(11)"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "lbl(12)"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "lbl(13)"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "lbl(14)"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "lbl(15)"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "lbl(4)"
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGridAsientos 
         ...
         _StyleDefs(104) =   "Splits(0).Columns(17).Style:id=28,.parent=13"
         _StyleDefs(105) =   "Splits(0).Columns(17).HeadingStyle:id=25,.parent=14"
         _StyleDefs(106) =   "Splits(0).Columns(17).FooterStyle:id=26,.parent=15"
         _StyleDefs(107) =   "Splits(0).Columns(17).EditorStyle:id=27,.parent=17"
   ...
   End
End
Attribute VB_Name = "frmMantAsiento"
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Select Case Index
     Case 0   'nuevo
        ...
        Call LimpiarForm(frmMantAsiento, "")
        txt(0).SetFocus
        Call ModoEditable(True, frmMantAsiento, "")
...
Private Sub cAcepta_Click()
  ...
  ElseIf modoedit = True Then
    ...
    SQL = SQL & "asientonumcorr01=" & VGvardllgen.ESNULO(txt(3).Text, 0) & ",asientonumcorr02=" & VGvardllgen.ESNULO(txt(4).Text, 0) & ",asientonumcorr03=" & VGvardllgen.ESNULO(txt(5).Text, 0) & ","
    SQL = SQL & "asientonumcorr04=" & VGvardllgen.ESNULO(txt(6).Text, 0) & ",asientonumcorr05=" & VGvardllgen.ESNULO(txt(7).Text, 0) & ",asientonumcorr06=" & VGvardllgen.ESNULO(txt(8).Text, 0) & ","
    SQL = SQL & "asientonumcorr07=" & VGvardllgen.ESNULO(txt(9).Text, 0) & ",asientonumcorr08=" & VGvardllgen.ESNULO(txt(10).Text, 0) & ",asientonumcorr09=" & VGvardllgen.ESNULO(txt(11).Text, 0) & ","
    SQL = SQL & "asientonumcorr10=" & VGvardllgen.ESNULO(txt(12).Text, 0) & ",asientonumcorr11=" & VGvardllgen.ESNULO(txt(13).Text, 0) & ",asientonumcorr12=" & VGvardllgen.ESNULO(txt(14).Text, 0) & ","
    ...
    SQL1 = SQL1 & "asientonumcorr01=" & VGvardllgen.ESNULO(txt(3).Text, 0) & "0,asientonumcorr02=" & VGvardllgen.ESNULO(txt(4).Text, 0) & ",asientonumcorr03=" & VGvardllgen.ESNULO(txt(5).Text, 0) & ","
    SQL1 = SQL1 & "asientonumcorr04=" & VGvardllgen.ESNULO(txt(6).Text, 0) & ",asientonumcorr05=" & VGvardllgen.ESNULO(txt(7).Text, 0) & ",asientonumcorr06=" & VGvardllgen.ESNULO(txt(8).Text, 0) & ","
    SQL1 = SQL1 & "asientonumcorr07=" & VGvardllgen.ESNULO(txt(9).Text, 0) & ",asientonumcorr08=" & VGvardllgen.ESNULO(txt(10).Text, 0) & ",asientonumcorr09=" & VGvardllgen.ESNULO(txt(11).Text, 0) & ","
    SQL1 = SQL1 & "asientonumcorr10=" & VGvardllgen.ESNULO(txt(12).Text, 0) & ",asientonumcorr11=" & VGvardllgen.ESNULO(txt(13).Text, 0) & ",asientonumcorr12=" & VGvardllgen.ESNULO(txt(14).Text, 0) & ","
  ...
  cAcepta.Enabled = False
  Set VGvardllgen = Nothing
  Call ModoEditable(False, frmMantAsiento, "")
  SSTab1.Tab = 0
  SSTab1.TabEnabled(1) = False
  SSTab1.TabEnabled(2) = False
  Exit Sub
...
Sub EditarAsiento()
 ...
 If rs.RecordCount > 0 Then
    With TDBGridAsientos
        ...
        chk(1).Value = IIf(.Columns(3).Value = 0, 0, 1)
        ChkCargo.Value = IIf(.Columns(18) = "", 0, .Columns(18))
        For i = 3 To 14
