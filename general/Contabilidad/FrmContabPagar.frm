...
Begin VB.Form FrmContabPagar 
   Caption         =   "Contabilizacion de Planillas de Aplicaciones PAGAR"
   ClientHeight    =   3855
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8955
   ...
   End
End
Attribute VB_Name = "FrmContabPagar"
...
rsparimpo.Open "ct_importarPagar", VGCNx, adOpenKeyset, adLockReadOnly
