...
Begin VB.Form frmMantPlantillaAsiento 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMantPlantillaAsiento.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame3"
      Tab(0).Control(1)=   "Frame2"
      Tab(0).Control(2)=   "lblNumRegAsientos"
      Tab(0).Control(3)=   "Label2"
      Tab(0).Control(4)=   "Label1"
      Tab(0).Control(5)=   "lblNumRegSubAs"
      Tab(0).ControlCount=   6
      TabCaption(1)   =   "Mantenimiento"
      TabPicture(1)   =   "frmMantPlantillaAsiento.frx":001C
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
            ...
            Splits(0)._ColumnProps(42)=   "Column(10).Width=2037"
            Splits(0)._ColumnProps(43)=   "Column(10).DividerColor=0"
            Splits(0)._ColumnProps(44)=   "Column(10)._WidthInPix=1958"
   ...
   End
End
Attribute VB_Name = "frmMantPlantillaAsiento"
...
Public Function LimpiarValores()
 Dim i As Integer
  ...
  Ctr_Ayucuenta.xclave = Empty: Ctr_Ayucuenta.Ejecutar
...
Private Sub ctr_ayucuenta_AlDevolverDato(ByVal ColecCampos As ADODB.Fields)
...
Private Sub ctr_ayucuenta_LostFocus()
  If modoinsert = True Or modoedit = True Then
     If Ctr_Ayucuenta.xclave = "00" Then
         txt(3).Enabled = True
         txt(3).SetFocus
...
Private Sub ctr_ayucuenta_KeyPress(KeyAscii As Integer)
 If modoinsert = True Or modoedit = True Then
    If KeyAscii = 13 Then
      If Ctr_Ayucuenta.xclave = "00" Then
        txt(3).SetFocus
...
Sub ModoPlantilla(Flag_Normal As Boolean)
  ...
  Ctr_Ayucuenta.Enabled = Flag_Normal
...
Function ValidaDataIngreso() As Boolean
 Dim i As Integer
  ...
  If Ctr_Ayucuenta.xclave = Empty Then
    ValidaDataIngreso = False
    Exit Function
  End If
...
Sub GrabarData()
 On Error GoTo X
  ...
  If modoinsert = True Then
        ...
        SQL = SQL & Ctr_Ayuda3.xclave & "','" & Ctr_Ayucuenta.xclave & "','" & UCase$(txt(1).Text) & "'," & chk.Value & ",'" & Ctr_Ayuda5.xclave & "',"
