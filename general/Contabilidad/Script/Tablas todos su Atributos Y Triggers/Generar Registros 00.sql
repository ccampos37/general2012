INSERT INTO ct_asiento
    (asientocodigo, asientodescripcion, usuariocodigo, fechaact)
...
INSERT INTO ct_subasiento
    (subasientocodigo, asientocodigo, monedacodigo, 
    subasientodescripcion, subasientoglosa, usuariocodigo, 
    fechaact)
VALUES ('00', '00', '00', '(Ninguno)', '(Ninguno)', 'Sistema', 
    '20/08/2002')
...
INSERT INTO ct_cuenta
    (cuentacodigo, cuentadescripcion, cuentalineaactivo, 
    cuentalineapasivo, cuentalineaegp, cuentanatu, cuentanategp, 
    cuentagrupo, cuentaestadoccostos, cuentaestadoanalitico, 
    cuentaestado, cuentadocumento, cuentanivel, 
    tipoanaliticocodigo, cuentaestadodistribucion, usuariocodigo, 
    fechaact)
VALUES ('00', '(Ninguno)',0,0,0,'0','0','00',0,0,0,0,0,'00',0,'Sistema','20/08/2002')
