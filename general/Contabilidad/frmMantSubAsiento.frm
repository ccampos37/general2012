...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Select Case Index
     ...
     Case 2   'eliminar
       If MsgBox("Desea eliminar el registro de SubAsiento Nº " & TDBGrid2.Columns(0).Value & "?", vbYesNo + vbDefaultButton2, "AVISO") = vbYes Then
...
X:
  If err.Number = -2147217873 Then
    MsgBox "Esta intentando registrar Código de SubAsiento Existente ", vbInformation, Caption
    txt(0).SetFocus
  Else
