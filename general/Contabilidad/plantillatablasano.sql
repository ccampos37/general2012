...
ALTER TABLE [dbo].[ct_cabcomprobxxxx] WITH NOCHECK ADD 
	...
	CONSTRAINT [DF_ct_cabcomprobxxxx_cabcomprobgrabada] DEFAULT (0) FOR [cabcomprobgrabada],
	CONSTRAINT [DF_ct_cabcomprobxxxx_cabcomprobnref] DEFAULT ('') FOR [cabcomprobnref],
	CONSTRAINT [DF_ct_cabcomprobxxxx_cabcomprobnlibro] DEFAULT ('') FOR [cabcomprobnlibro],
	CONSTRAINT [DF_ct_cabcomprobxxxx_cabcomprobnprovi] DEFAULT ('') FOR [cabcomprobnprovi]
GO
...
ALTER TABLE [dbo].[ct_detcomprobxxxx] WITH NOCHECK ADD 
	...
	CONSTRAINT [DF_ct_detcomprobxxxx_detcomprobnlibro] DEFAULT ('') FOR [detcomprobnlibro]
GO
...
ALTER TABLE [dbo].[ct_detcomprobxxxx] ADD 
	CONSTRAINT [FK_ct_detcomprobxxxx_ct_analitico] FOREIGN KEY 
	(
		[analiticocodigo]
	) REFERENCES [dbo].[ct_analitico] (
		[analiticocodigo]
