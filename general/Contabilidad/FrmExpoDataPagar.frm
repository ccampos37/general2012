...
Begin VB.Form FrmExpoDataPagar 
   Caption         =   "Contabilizacion de Cuentas por Pagar"
   ClientHeight    =   2955
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7965
   ...
   End
End
Attribute VB_Name = "FrmExpoDataPagar"
...
rsparimpo.Open "ct_impoPagar", VGCNx, adOpenKeyset, adLockReadOnly
...
Call DeleteDataPlanillaPagar(rsparimpo!Asiento, rsparimpo!SubAsiento, Format(Month(DTPPerido), "00"), Year(DTPPerido))
    VGGeneral.BeginTrans
    Set COMANDO = New ADODB.Command
    With COMANDO
        .CommandType = adCmdStoredProc
        .CommandText = "cc_GeneraAsientoPagarenLinea_pro"
...
Sub DeleteDataPlanillaPagar(Asiento As String, SubAsiento As String, mes As Integer, anno As String)
 Dim SQL As String
