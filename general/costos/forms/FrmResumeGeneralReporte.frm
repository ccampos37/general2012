...
Begin VB.Form FrmResumeGeneralReporte 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   675
         Left            =   480
         Picture         =   "FrmResumeGeneralReporte.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   1200
         Width           =   780
      ...
      Begin VB.CommandButton cmdImp 
         ...
         Height          =   675
         Left            =   480
         Picture         =   "FrmResumeGeneralReporte.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   480
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmResumeGeneralReporte"
...
If Option02 Then
 ...
 Else
   ...
   aparam(6) = "01"
End If
Call ImpresionRptProc("cs_ResumenMensual1.rpt", aform, aparam, , "Resumen Mensual")
If Check1.Value Then
   If OptionMes.Value = True Then
      If estado = 1 Then
         aparam(4) = 4
         Call ImpresionRptProc("cs_ResumenMensualdetallado1.rpt", aform, aparam, , "Resumen Mensual deatallado")
      End If
    Else
      aparam(4) = 4
      Call ImpresionRptProc("cs_ResumenMensualdetallado1.rpt", aform, aparam, , "Resumen Mensual deatallado")
