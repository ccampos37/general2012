...
Begin VB.Form FrmPuntoEquilibrio 
   Caption         =   "Form1"
   ClientHeight    =   1800
   ClientLeft      =   120
   ClientTop       =   420
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   675
         Left            =   1440
         Picture         =   "FrmPuntoEquilbrio.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   480
         Width           =   780
      ...
      Begin VB.CommandButton cmdImp 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "FrmPuntoEquilbrio.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   480
         Width           =   775
   ...
   End
End
Attribute VB_Name = "FrmPuntoEquilibrio"
...
aparam(4) = VGComputer
aparam(5) = 0
aparam(6) = TxFertipocambio.valor
...
If DTPicker2.Value <> DTPicker1.Value Then
   aform(1) = "@Fecha='  AL : " & fecha & "'"
 Else
   aform(1) = "@Fecha='  DEL DIA : " & fecha & "'"
 End If
...
Else
    aform(2) = "@Detalle=0"
End If
aform(3) = "@TituloReporte='PUNTO DE EQUILIBRIO'"
aparam(8) = DTPicker2.Value - DTPicker1.Value + 1
Call ImpresionRptProc("cs_CostosPuntoEquilibrio.rpt", aform, aparam, , "Resumen Diario")
End Sub
