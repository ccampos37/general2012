...
'        Next
    ...
    'Case 8
        'Listado
    Case 11
        If MBox(11) = Empty Then
            MsgBox "Falta ingresar e-mail de cliente.", vbInformation, "Sistema"
            MBox(11).SetFocus
            adll.ActivaTab 1, 1, SSTab1
            Exit Sub
        End If
...
Public Function CargaData()
  ...
  If rsc.RecordCount > 0 Then
        ...
        MBox(5) = Left(Escadena(rsc!clientedireccion), 64)
        ...
        Combo7.ListIndex = BuscaCombo2(Combo7, Trim(numero(rsc!clientediasmaxpagocont)))
