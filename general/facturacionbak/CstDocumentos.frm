...
Begin VB.Form CstDocumentos 
   ...
   End
End
Attribute VB_Name = "CstDocumentos"
...
Private Sub aBusca_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
  ...
  If KeyCode = 112 Then  ' Ayuda de Productos
       ...
       Else
            nsql = "CASE pedidoestado WHEN '1' THEN '*' ELSE '' END,pedidofecha as Fecha,pedidonrofact as Documento,clientecodigo as Codigo,clienterazonsocial as Cliente,pedidototneto as Total"
       End If
...
Private Sub cBusca_Click()
    ...
    nsql = "select * from vt_pedido where empresacodigo='" & VGParametros.empresacodigo & "' and pedidonrofact='" & Trim(aBusca(0) & aBusca(1)) & "' and pedidotipofac='" & Left(Combo2.Text, 2) & "'"
    ...
    If csql.RecordCount > 0 Then
        nvalor = Escadena(csql!pedidonumero)
            ...
            Label2(1) = csql!pedidotipofac & "-" & Escadena(csql!pedidonrofact)
        ...
        Set acliente = VGCNx.Execute("select * from vt_modoventa where modovtacodigo='" & Escadena(csql!modovtacodigo) & "'")
        If acliente.RecordCount > 0 Then
           Label2(9) = Escadena(acliente!modovtacodigo) & "-" & Escadena(acliente!modovtadescripcion)
        Else
            Label2(9) = ""
        End If
        acliente.Close
        ...
        Set acliente = VGCNx.Execute("select * from vt_formapago where formapagocodigo='" & Escadena(csql!formapagocodigo) & "'")
        If acliente.RecordCount > 0 Then
           Label2(10) = Escadena(acliente!formapagocodigo) & "-" & Escadena(acliente!formapagodescripcion)
        Else
           Label2(10) = ""
        End If
        acliente.Close
...
Private Sub Form_Load()
    ...
    Call Limpiartexto(MBox2, 6, 10)
    Call CargarTipo(Combo2, 6)    'Todos los documentos
    Call CargaGrilla
