...
Begin VB.Form FrmListaPrecios 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "cmdBotones(11)"
      Tab(1).Control(1)=   "cmdBotones(12)"
      Tab(1).Control(2)=   "cBusca"
      Tab(1).Control(3)=   "aBusca(0)"
      Tab(1).Control(4)=   "aBusca(1)"
      Tab(1).Control(5)=   "Frame3"
      Tab(1).Control(6)=   "Frame5(0)"
      Tab(1).Control(7)=   "TDBGrid2"
...
Private Sub cBoton_Click(Index As Integer)
  ...
  If Index = 0 Then
    ...
    VGCNx.Execute "CREATE TABLE Listapre" & Trim(Lpre.Text) & _
               ...
               "productodescrcorta char(30), grupovtacodigo char(2),productofamiliacodigo char(3)," & _
               ...
               "productoprecvtaofi float,productoprecvtareparto float,unidadcodigo char(3)," & _
               "unidadreferencial char(3),monedacodigo char(2),empresacodigo char(2)," & _
    ...
    Else
       ...
       FrmProcesolista.bfactordvta = CDbl(MBox3(1))
       FrmProcesolista.bfactordreparto = CDbl(MBox3(2))
       FrmProcesolista.bsqlini = "select * From vt_Producto"
    End If
  ...
  ElseIf Index = 3 Then
     ...
     asql = "select productocodigo,productodescripcion,productoprecvta,almacencodigo from " & archilista & ""
