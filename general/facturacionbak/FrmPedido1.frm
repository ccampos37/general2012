...
Begin VB.Form FrmPedido 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmPedido1.frx":0000
      ...
      TabPicture(1)   =   "FrmPedido1.frx":001C
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "FrmPedido1.frx":1582
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "Fr1(0)"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Datos Detalle"
         TabPicture(1)   =   "FrmPedido1.frx":159E
         Tab(1).ControlEnabled=   -1  'True
         ...
         TabPicture(2)   =   "FrmPedido1.frx":15BA
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         PrintInfos(0).PageHeaderFont=   "Size=9.6,Charset=0,Weight=700,Underline=0,Italic=0,Strikethrough=0,Name=System"
         PrintInfos(0).PageFooterFont=   "Size=9.6,Charset=0,Weight=700,Underline=0,Italic=0,Strikethrough=0,Name=System"
  ...
  Select Case Index
   ...
   Case 3, 4, 5
      ...
      If Index Like "[45]" Then
         MBox2(Index) = Format(MBox2(Index), "######0.000")  ' Numero(MBox2(Index))
       Else
   ...
   If modoventa.emiteguia = "1" Then
        ...
        Cn.Execute "UPDATE vt_pedido set pedidonrogiarem='" & nguia & "'" & _
          ...
          If rb.RecordCount > 0 Then
             ...
             If cuenta >= 1 Then
                For J = 1 To cuenta
                   Cn.Execute "INSERT INTO gtempfile(detpedcantpedida,productocodigo,productodescripcion,detpedmontoprecvta,detpedimpbruto,detpeddsctoxitem,detpedfactorconv,unidadcodigo)" & _
