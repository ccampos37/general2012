...
Begin VB.Form FrmVentasxZonas 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmVentasxZona.frx":0000
      ...
      TabPicture(1)   =   "FrmVentasxZona.frx":001C
   ...
   End
End
Attribute VB_Name = "FrmVentasxZonas"
...
Public Function MuestraDatosAsiento()
  ...
  SQL = SQL & "B.zonames01, B.zonames02, B.zonames03, B.zonames04,"
  SQL = SQL & "B.zonames05, B.zonames06, B.zonames07, B.zonames08,"
  SQL = SQL & "B.zonames09, B.zonames10, B.zonames11, B.zonames12"
  SQL = SQL & " FROM  vt_zona a, vt_ventasxzonas b "
  SQL = SQL & "where b.empresacodigo='" & VGParametros.empresacodigo & "'"
...
Private Sub cmdBotones_Click(Index As Integer)
  ...
  Select Case Index
     Case 0   'nuevo
        ...
        txt(0).SetFocus
        Call ModoEditable(True, FrmVentasxZonas, "")
     ...
     Case 2   'eliminar
       If MsgBox("Desea eliminar el registro de SubAsiento Nº " & TDGrid1.Columns(0).Value & "?", vbYesNo + vbDefaultButton2, "AVISO") = vbYes Then
...
Private Sub cAcepta_Click()
  ...
  If modoinsert = True Then
    ...
    SQL = SQL & "zonames01,zonames02,zonames03,zonames04,zonames05,zonames06,zonames07,zonames08,zonames09,zonames10,zonames11,zonames12,usuariocodigo,fechaact,librocodigo,asientoadicionacargo) "
    ...
    SQL1 = SQL1 & "zonames01,zonames02,zonames03,zonames04,zonames05,zonames06,zonames07,zonames08,zonames09,zonames10,zonames11,zonames12,usuariocodigo,fechaact) "
  ...
  ElseIf modoedit = True Then
    ...
    SQL = SQL & "zonames01=" & VGvardllgen.ESNULO(txt(3).Text, 0) & ",zonames02=" & VGvardllgen.ESNULO(txt(4).Text, 0) & ",zonames03=" & VGvardllgen.ESNULO(txt(5).Text, 0) & ","
    SQL = SQL & "zonames04=" & VGvardllgen.ESNULO(txt(6).Text, 0) & ",zonames05=" & VGvardllgen.ESNULO(txt(7).Text, 0) & ",zonames06=" & VGvardllgen.ESNULO(txt(8).Text, 0) & ","
    SQL = SQL & "zonames07=" & VGvardllgen.ESNULO(txt(9).Text, 0) & ",zonames08=" & VGvardllgen.ESNULO(txt(10).Text, 0) & ",zonames09=" & VGvardllgen.ESNULO(txt(11).Text, 0) & ","
    SQL = SQL & "zonames10=" & VGvardllgen.ESNULO(txt(12).Text, 0) & ",zonames11=" & VGvardllgen.ESNULO(txt(13).Text, 0) & ",zonames12=" & VGvardllgen.ESNULO(txt(14).Text, 0) & ","
    ...
    SQL1 = SQL1 & "zonames01=" & VGvardllgen.ESNULO(txt(3).Text, 0) & "0,zonames02=" & VGvardllgen.ESNULO(txt(4).Text, 0) & ",zonames03=" & VGvardllgen.ESNULO(txt(5).Text, 0) & ","
    SQL1 = SQL1 & "zonames04=" & VGvardllgen.ESNULO(txt(6).Text, 0) & ",zonames05=" & VGvardllgen.ESNULO(txt(7).Text, 0) & ",zonames06=" & VGvardllgen.ESNULO(txt(8).Text, 0) & ","
    SQL1 = SQL1 & "zonames07=" & VGvardllgen.ESNULO(txt(9).Text, 0) & ",zonames08=" & VGvardllgen.ESNULO(txt(10).Text, 0) & ",zonames09=" & VGvardllgen.ESNULO(txt(11).Text, 0) & ","
    SQL1 = SQL1 & "zonames10=" & VGvardllgen.ESNULO(txt(12).Text, 0) & ",zonames11=" & VGvardllgen.ESNULO(txt(13).Text, 0) & ",zonames12=" & VGvardllgen.ESNULO(txt(14).Text, 0) & ","
