...
Begin VB.Form FrmIngreso 
   ...
   Caption         =   "Jck - Telf. 780-1997 /  Nextel 115*5466"
   ClientHeight    =   5085
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9675
...
Dim xsql As New ADODB.Recordset
  tccambio = XRecuperaTipoCambio(DTPfecha.Value, Venta, VGcnxCT)
   ...
   If Len(Trim(Combo2.Text)) = 0 Then
       ...
       Exit Sub
   End If
   If adll.VerificaDatoExistente(VGconfig, "select * from usuario where usu_codigo='" & MText(0) & "'") = 0 Then
