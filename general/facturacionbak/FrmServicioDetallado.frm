...
Begin VB.Form FrmPedido 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmServicioDetallado.frx":0000
      ...
      TabPicture(1)   =   "FrmServicioDetallado.frx":001C
      ...
      TabPicture(2)   =   "FrmServicioDetallado.frx":0038
      ...
      Begin VB.Frame frmbotones 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   4
            Left            =   3375
            Picture         =   "FrmServicioDetallado.frx":0054
            Style           =   1  'Graphical
            TabIndex        =   152
            Top             =   180
            Width           =   870
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   2
            Left            =   2340
            Picture         =   "FrmServicioDetallado.frx":0496
            Style           =   1  'Graphical
            TabIndex        =   151
            Top             =   180
            Width           =   825
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   1
            Left            =   1260
            Picture         =   "FrmServicioDetallado.frx":08D8
            Style           =   1  'Graphical
            TabIndex        =   150
            Top             =   180
            Width           =   870
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   0
            Left            =   180
            Picture         =   "FrmServicioDetallado.frx":0D1A
            Style           =   1  'Graphical
            TabIndex        =   149
            Top             =   180
            Width           =   870
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   150
            Picture         =   "FrmServicioDetallado.frx":115C
            Top             =   210
            Width           =   480
         End
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "FrmServicioDetallado.frx":159E
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "Fr1(0)"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Datos Detalle"
         TabPicture(1)   =   "FrmServicioDetallado.frx":15BA
         Tab(1).ControlEnabled=   -1  'True
         ...
         TabPicture(2)   =   "FrmServicioDetallado.frx":15D6
         Tab(2).ControlEnabled=   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   12
            Left            =   1050
            Picture         =   "FrmServicioDetallado.frx":179D
            Style           =   1  'Graphical
            TabIndex        =   56
            Top             =   180
            Width           =   855
         ...
         Begin VB.CommandButton cmdBotones 
            ...
            Index           =   11
            Left            =   90
            Picture         =   "FrmServicioDetallado.frx":1BDF
            Style           =   1  'Graphical
            TabIndex        =   55
            Top             =   180
            Width           =   870
...
Private Sub cAyuda_Click(Index As Integer)
  ...
  ElseIf Index = 3 Then                             ' Ayuda de Productos
       ...
       If Combo2.ListCount > 0 Then
             FrmAyuda.BTabla = "[" & VGCNx.DefaultDatabase & "].dbo.maeart left join [" & _
