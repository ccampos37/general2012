...
Begin VB.Form FrTipoEst 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tipo Estudios"
   ClientHeight    =   4830
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4560
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   150
      Picture         =   "FrTipoEst.frx":0015
      Top             =   180
      Width           =   480
   End
   Begin VB.Label Label1 
      BackColor       =   &H8000000D&
      Caption         =   $"FrTipoEst.frx":0457
      ForeColor       =   &H8000000E&
      Height          =   585
      Left            =   750
      TabIndex        =   1
...
SQLSTR = "SELECT COD_TEST AS CODIGO, TIPOEST_DESCRIP AS [TIPO ESTUDIOS] FROM TIPO_ESTUDIOS ORDER BY COD_TEST"
