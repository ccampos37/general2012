...
Begin VB.Form frRepNivCcost 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Imprimir Centros de Costos x Trabajo x Nivel"
   ClientHeight    =   3180
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4695
   Icon            =   "frRepNivCcost.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frRepNivCcost.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frRepNivCcost.frx":075E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frRepNivCcost.frx":1046
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image xMarcaTodos 
      Height          =   240
      Left            =   3105
      Picture         =   "frRepNivCcost.frx":192E
      Top             =   195
      Width           =   240
   End
   ...
   End
End
Attribute VB_Name = "frRepNivCcost"
...
Public Sub CARGAREGS()
    ...
    SqlCad = "SELECT * FROM  [##TMPCCOSTO" & VGL_COMPUTER & "]  WHERE NIVEL=" & Str(CmbNivel.ListIndex)
...
Private Sub Command1_Click()
    ...
    'RECORRE EL LW PARA ARMAR LA CADENA DE CONSULTA DEPENDIENDO DE LOS CHECKS
    SqlCad.Text = ""
    For Each XITEM In LvNivel.ListItems
        If XITEM.Checked Then
            SqlCad.Text = SqlCad.Text & "T.CCOSTO LIKE '" & Trim(XITEM.Text) & "%' OR "
        End If
    Next
    If SqlCad.Text = "" Then
...
Private Sub IMPRIMIR(SELE As TextBox)
    ...
    If ExisteTablaAux(" [##TMPREPCOSTTRAB" & VGL_COMPUTER & "] ") Then DBSTARPLAN.Execute "DROP TABLE  [##TMPREPCOSTTRAB" & VGL_COMPUTER & "] "
    ...
    DBSTARPLAN.Execute "" & _
        ...
        "STR(0) AS CODAUX  " & _
        " INTO  [##TMPREPCOSTTRAB" & VGL_COMPUTER & "]  " & _
        " FROM " & REGSISTEMA.BASESQL & ".dbo.TRABAJADORES AS T WHERE  " & SELE.Text, X
    If X = 0 Then
    ...
    Dim RSTEMP As New ADODB.Recordset
    RSTEMP.Open "SELECT CODTRAB,CCOSTO,CODAUX FROM  [##TMPREPCOSTTRAB" & VGL_COMPUTER & "] ", _
    DBSTARPLAN, adOpenDynamic, adLockOptimistic
    RSTEMP.MoveFirst
    Do While Not RSTEMP.EOF
        RSTEMP!CODAUX = Getcad(".", CmbNivel.ListIndex + 1, RSTEMP!CCosto)
        RSTEMP.Update
        RSTEMP.MoveNext
    Loop
    Set RSTEMP = Nothing
    
    'SE CREA OTRO TEMPORAL PARA HACER LA UNION CON LOS DATOS DEL AREA DEL NIVEL
    'HA IMPRIMIR
    DBSTARPLAN.Execute "EXECUTE CREA_TMP_CCOSTO '" & REGSISTEMA.BASESQL & "','" & VGL_COMPUTER & "'"
    Screen.MousePointer = 1
        
    With Reporte
        .Reset
        .ReportFileName = REGSISTEMA.REPORTES & "PLAN0013.RPT"
        ...
        .WindowTitle = "PLAN0013 - TRABAJADORES POR NIVELES Y CENTROS DE COSTOS "
    ...
    End With
        If ExisteTablaSQL("TMPREPCOSTTRAB1" & USUARIOINI, DBSTARPLAN) Then DBSTARPLAN.Execute "DROP TABLE TMPREPCOSTTRAB1" & USUARIOINI
    Exit Sub
ERRADO:
        Resume Next
        Screen.MousePointer = 1
