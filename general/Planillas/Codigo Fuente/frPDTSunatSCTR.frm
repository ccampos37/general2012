...
Begin VB.Form frPDTSunatSCTR 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Resultados de la Exportación de Planillas para el PDT  - Formulario 0600 para la versión PDT Sunat 2.0"
      ForeColor       =   &H8000000E&
      Height          =   390
      Left            =   615
      TabIndex        =   0
...
Private Sub CMEXPORTAR_CLICK()
    On Error GoTo Err1
            ...
            If Dir$(xFile) <> "" Then
                If MsgBox("YA EXISTE EN ESTA RUTA UN ARCHIVO CORRESPONDIENTE AL PDT SUNAT - REMUNERACIONES, DESEA UD. REEMPLAZAR EL ARCHIVO POR EL NUEVO QUE ESTÁ PROCESANDO", vbYesNo + vbQuestion) = vbNo Then Exit Sub
                Kill xFile
            End If
...
Private Sub CMQUITAR_CLICK()
    If RSPDT.RecordCount = 0 Or RSPDT.EOF Then
        ...
        Exit Sub
    End If
    If MsgBox("REALMENTE DESEA QUITAR DE LA EXPORTACIÓN PARA EL PDT SUNAT AL TRABAJADOR " & RSPDT!NOMBRES, vbYesNo + vbQuestion) = vbNo Then Exit Sub
