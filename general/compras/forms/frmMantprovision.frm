...
Begin VB.Form frmMantprovision 
   ...
   ClientTop       =   330
   ClientWidth     =   12150
   Icon            =   "frmMantprovision.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTabMant 
      ...
      TabPicture(0)   =   "frmMantprovision.frx":1272
      ...
      Begin VB.Frame FrameCabecera 
         ...
         Begin VB.ComboBox CmbTcambio 
            Enabled         =   0   'False
            Height          =   288
            ItemData        =   "frmMantprovision.frx":12AA
            Left            =   4410
            List            =   "frmMantprovision.frx":12B7
         ...
         Begin ctrlayuda_f.Ctr_Ayuda CtrAyu_Modoprovi 
            ...
            ListaCampos     =   $"frmMantprovision.frx":12E3
      ...
      Begin VB.Frame FrameConsul 
         ...
         Begin VB.Image Image1 
            Height          =   465
            Left            =   135
            Picture         =   "frmMantprovision.frx":1372
            Stretch         =   -1  'True
            Top             =   210
            Width           =   450
         End
      ...
      Begin MSComctlLib.StatusBar StBar 
         ...
         BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Panel3 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
               ...
               AutoSize        =   1
               Object.Width           =   8334
               Picture         =   "frmMantprovision.frx":25E4
               Text            =   "Estado :"
               TextSave        =   "Estado :"
            EndProperty
         EndProperty
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabsPerRow      =   1
         TabHeight       =   520
         MouseIcon       =   "frmMantprovision.frx":3866
         TabCaption(0)   =   "&Ingreso del detalle"
         TabPicture(0)   =   "frmMantprovision.frx":3882
         Tab(0).ControlEnabled=   -1  'True
         ...
         Begin VB.Frame FramDetalle 
            ...
            Begin ctrlayuda_f.Ctr_Ayuda CtrAyu_Cuenta 
               ...
               ListaCampos     =   $"frmMantprovision.frx":389E
...
Private Sub actualizaactivos(ByRef rs As ADODB.Recordset)
On Error GoTo erroractivos
Dim rb As ADODB.Recordset
Dim X As Integer
Dim xnumero As Long
X = 0
...
VGCommandoSP.ActiveConnection = VGGeneral
VGCommandoSP.CommandType = adCmdStoredProc
VGCommandoSP.CommandText = "co_asientoactivosfijos"
VGCommandoSP.Parameters.Refresh
With VGCommandoSP
    .Parameters("@base") = VGCNx.DefaultDatabase
    .Parameters("@empresa") = Ctr_AyuEmpresaactivos.xclave
...
If rb.RecordCount > 0 Then
    ...
    While Not rb.EOF
        ...
        rs!inafecto = rb!importe
        rs!Impcompra = rb!importe
        rs!Ccosto = rb!centrocostocodigo
        rs.Update
        rb.MoveNext
    Wend
     FrameActivos.Visible = False
     Ctr_Ayuempresa.xclave = Ctr_AyuEmpresaactivos.xclave
     CtrAyu_moneda.xclave = "01"
End If
Call VGvardllgen.ActivaTab(1, 1, SSTabMant)
Call HabilitarDetalle(True, FramDetalle, Me)
...
erroractivos:
End Sub
Private Sub CmdAceptarActivos_Click()
Call actualizaactivos(rsmantenimiento)
Call PBoton(1)
End Sub

Private Sub CmdSalirActivos_Click()
Dim xnumero As Long
Call VGvardllgen.ActivaTab(1, 1, SSTabMant)
Call HabilitarDetalle(True, FramDetalle, Me)
lbNumComprobCab.Caption = UltNumeroAuto(VGParamSistem.TablaCabcomprob, 1, VGCNx)
...
Private Sub activosfijos()
FrameActivos.Visible = True
End Sub
